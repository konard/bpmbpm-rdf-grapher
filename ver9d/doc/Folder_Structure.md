...
Проект RDF Grapher ver9d организован по модульному принципу. Каждый функциональный модуль размещен в отдельной пронумерованной папке (1_ -- 12_), что обеспечивает четкое разделение ответственности и независимость модулей. 
