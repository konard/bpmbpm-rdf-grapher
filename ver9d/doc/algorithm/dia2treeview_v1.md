...
| Файл | Изменения |
|------|-----------|
| `ver9d/9_vadlib/vadlib.js` | Добавлены глобальные переменные `diagramNavigationHistory` и `diagramNavigationIndex` |
| `ver9d/index.html` | Добавлены кнопки навигации в заголовок панели диаграммы |
| `ver9d/styles.css` | Добавлены стили для кнопок навигации |
| `ver9d/5_publisher/5_publisher_trig.js` | Добавлены функции навигации, синхронизации TreeView, обновлён `selectTriG()` |
| `ver9d/5_publisher/5_publisher_logic.js` | Добавлен сброс истории при загрузке данных, инициализация истории |
| `ver9d/doc/algorithm/dia2treeview_v1.md` | Данный документ |
