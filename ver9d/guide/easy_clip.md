## easy_clip.md
Пример описания процесса на примере процесса изготовления Канцелярской скрепки (paper clip) 
...
Далее создаем к ним (процессам) исполнителей: выделяем нужный Индивид процесса, например, p1_1.   
