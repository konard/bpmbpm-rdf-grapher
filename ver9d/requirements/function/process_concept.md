...
- не нужно учесть, что нет ссылок извне на индивид, т.к. [resume](https://github.com/bpmbpm/rdf-grapher/blob/main/ver9d/analysis/new_individ_process.md#31-resume-bpmbpm) ссылки только на TriG (дочерний или внешний) через virtualRDFdata
...
## Also
- https://github.com/bpmbpm/rdf-grapher/blob/main/ver9d/doc/algorithm/io_concept_individ_v3.md
...
### Method
https://github.com/bpmbpm/rdf-grapher/pull/405	создание  
1. Метод "New Process Individ" для схемы процесса  
Расположение: Кнопка "Методы" на схеме процесса (диаграмма)  
2. Метод "New Executor Individ" для индивида процесса  
Расположение: Кнопка "Метод" в окне "Свойства объекта диаграммы" для индивида процесса  

Хотел (не стал, чтобы функция 1:1 вызывалась): Замечания к https://github.com/bpmbpm/rdf-grapher/pull/405
