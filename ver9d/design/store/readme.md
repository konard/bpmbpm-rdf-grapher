## store
- https://github.com/bpmbpm/rdf-grapher/blob/main/ver9d/design/store/ontology_store.md_v1.md
- https://github.com/bpmbpm/rdf-grapher/blob/main/ver9d/doc/quadstore_io.md
...
- Обновление документации: файл 10_virtualTriG.md с указанием проблемы ver9d_1rea1c  #324
...
| File | Changes |
|------|---------|
| `ver9d/9_vadlib/vadlib.js` | Restored currentQuads, added getCurrentQuads() and syncCurrentQuads() |
| `ver9d/5_publisher/5_publisher_logic.js` | Added syncCurrentQuads() calls after store init |
| `ver9d/2_triplestore/2_triplestore_logic.js` | Added syncCurrentQuads() call |
| `ver9d/2_triplestore/2_triplestore_ui.js` | Use getCurrentQuads() as fallback |
| `ver9d/3_sd/3_sd_logic.js` | Use getCurrentQuads() and syncCurrentQuads() |
| `ver9d/3_sd/3_sd_ui.js` | Use getCurrentQuads() for quad iteration |
| `ver9d/3_sd/3_sd_create_new_concept/3_sd_create_new_concept_logic.js` | Use getCurrentQuads() |
| `ver9d/3_sd/3_sd_create_new_individ/3_sd_create_new_individ_logic.js` | Use getCurrentQuads() |
| `ver9d/3_sd/3_sd_create_new_trig/3_sd_create_new_trig_logic.js` | Use getCurrentQuads() |
| `ver9d/3_sd/3_sd_del_concept_individ/3_sd_del_concept_individ_logic.js` | Use getCurrentQuads() |
| `ver9d/8_infoSPARQL/8_infoSPARQL_ui.js` | Use getCurrentQuads() |

## Test Plan

- [ ] Load index.html from ver9d directory
...
## 3 Удаление вслед за currentQuads и virtualRDFdata и других массивов
