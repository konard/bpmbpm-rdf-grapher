...
- `ver9d/experiments/test_comunica_import.js` - Тестирование импорта Comunica
- `ver9d/9_vadlib/vadlib_sparql.js` - Примеры SPARQL функций
- `ver9d/2_triplestore/2_triplestore_logic.js` - Примеры работы с N3.Store
