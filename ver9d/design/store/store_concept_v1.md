...
Документ описывает концепцию использования techtree и currentQuads в приложении RDF Grapher ver9d. Основная задача — определить оптимальный способ хранения технологических данных из файла `vad-basic-ontology_tech_Appendix.ttl` и их взаимодействие с основным quadstore.
...
3. **Сохранить** файлы `Trig_VADv5.ttl` и `Trig_VADv6.ttl` в папке `ver9d/`
