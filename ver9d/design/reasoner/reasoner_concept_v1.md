...
В проекте RDF Grapher ver9d реализован механизм **Virtual RDF Data** — автоматически вычисляемых свойств процессов, которые не хранятся непосредственно в RDF-данных пользователя, а рассчитываются при загрузке на основе структуры данных.

Взаимодействие Virtual TriG и virtualRDFdata с quadstore описано в документе [quadstore_io.md](https://github.com/bpmbpm/rdf-grapher/blob/main/ver9d/doc/quadstore_io.md)
