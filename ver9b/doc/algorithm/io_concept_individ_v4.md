...
1. **10 разделов по операциям** — полное покрытие создания и удаления для концептов, индивидов и схем
...
## 7. Удаление индивида процесса — полный алгоритм

> Обновлённый раздел (issue #309, п.2). Реализован полный алгоритм удаления с каскадной очисткой по каждому TriG.
...
## 8. Удаление индивида исполнителя

> Новый раздел, добавленный в v4 (issue #309).
...
*Документ создан в рамках PR #310 по issue #309*
