...
В проекте RDF Grapher ver9b реализован механизм **Virtual RDF Data** — автоматически вычисляемых свойств процессов, которые не хранятся непосредственно в RDF-данных пользователя, а рассчитываются при загрузке на основе структуры данных.
