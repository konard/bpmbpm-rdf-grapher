...
Данный файл содержит определения терминов, используемых в VAD Ontology (ver9b) и проекте RDF Grapher.
...
- [RDF Grapher ver9b](index.html) — основное приложение, корень ver9b
