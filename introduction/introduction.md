...
| технологическое приложение к основной процессной онтологии (методы, предикаты), см. папку ontology/vad-basic-ontology_tech_Appendix.trig| `vad:techtree` | Метаданные: методы, предикаты, типы |
