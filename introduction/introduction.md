...
**Текущая версия** [ver9d](https://github.com/bpmbpm/rdf-grapher/tree/main/ver9d) представляет собой прототип Semantic ARIS — ARIS-подобной системы моделирования, построенной на стеке Linked Data.
