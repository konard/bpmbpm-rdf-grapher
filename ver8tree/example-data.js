/**
 * Example data for RDF Grapher ver8
 * Issue #227: Moved from index.html to separate file
 */
...
const EXAMPLE_DATA = {
    // TriG VADv5 пример с иерархией объектов через hasParentObj
...
`,
    // Issue #219 Fix #5: TriG VADv6 пример с дополнительным блоком pDel для тестирования удаления
