...
class Resource {
    ...
    isA(type) {
        ...
        if (typeof type === 'string') {
            ...
            type = (0, rdf_string_1.stringToTerm)(typeExpanded);
        }
    ...
    addProperty(predicate, object) {
        const propertyUri = (0, rdf_string_1.termToString)(predicate.term);
    ...
    toJSON(maxDepth = -1) {
        if (Object.keys(this.properties).length === 0 && !this.list) {
            return (0, rdf_string_1.termToString)(this.term);
        }
        return Object.assign(Object.assign({ '@id': (0, rdf_string_1.termToString)(this.term) }, maxDepth !== 0 && Object.keys(this.properties).length > 0 ?
            {
    ...
    toQuads(quads = [], dataFactory = new rdf_data_factory_1.DataFactory(), excludeResources = {}) {
        ...
        const resourceId = (0, rdf_string_1.termToString)(this.term);
