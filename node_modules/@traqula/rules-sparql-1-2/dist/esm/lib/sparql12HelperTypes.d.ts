 ...
 */
ParamType extends any[] = []> = SparqlGrammarRule<NameType, ReturnType, ParamType> & SparqlGeneratorRule<NameType, GenInputType, ParamType>;
 ...
 * Function arguments that can be given to convey the state of the current parse operation.
 */
ParamType extends any[] = []> = GeneratorRule<SparqlGeneratorContext, NameType, ReturnType, ParamType>;
 ...
 * Function arguments that can be given to convey the state of the current parse operation.
 */
ParamType extends any[] = []> = ParserRule<SparqlContext, NameType, ReturnType, ParamType>;
export type SparqlContext = T11.SparqlContext & {
    astFactory: AstFactory;
};
export type SparqlGeneratorContext = T11.SparqlGeneratorContext & {
    astFactory: AstFactory;
};
