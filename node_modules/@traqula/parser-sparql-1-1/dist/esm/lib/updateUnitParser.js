...
export const updateParserBuilder = ParserBuilder.create(updateNoModifyParserBuilder)
    ...
    .addMany(gram.modify, gram.deleteClause, gram.insertClause, gram.usingClause, gram.defaultGraphClause, gram.namedGraphClause, gram.sourceSelector, gram.usingClauseStar, gram.groupGraphPattern)
    // This substitutes all of propertyListNotEmpty
    .merge(objectListParserBuilder, [])
    .merge(subSelectParserBuilder, []);
//# sourceMappingURL=updateUnitParser.js.map