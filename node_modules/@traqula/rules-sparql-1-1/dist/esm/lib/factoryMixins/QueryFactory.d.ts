...
import type { ContextDefinition, DatasetClauses, PatternBgp, PatternGroup, PatternValues, QueryConstruct, QuerySelect, SolutionModifiers } from '../Sparql11types.js';
import type { Constructor } from './mixins.js';
type NodeType = 'query';
export declare function QueryFactoryMixin<TBase extends Constructor<AstCoreFactory>>(Base: TBase): {
    new (...args: any[]): {
        isQuery(obj: object): obj is Typed<NodeType>;
        isQuerySelect(obj: object): obj is SubTyped<NodeType, "select">;
        queryConstruct(loc: SourceLocation, context: ContextDefinition[], template: PatternBgp, where: PatternGroup, solutionModifiers: SolutionModifiers, datasets: DatasetClauses, values?: PatternValues): QueryConstruct;
        isQueryConstruct(obj: object): obj is SubTyped<NodeType, "construct">;
        isQueryDescribe(obj: object): obj is SubTyped<NodeType, "describe">;
        isQueryAsk(obj: object): obj is SubTyped<NodeType, "ask">;
        querySelect(arg: Omit<QuerySelect, "type" | "subType" | "loc">, loc: SourceLocation): QuerySelect;
