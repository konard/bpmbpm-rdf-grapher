...
import { anonPattern, blankNodeLabelPattern, commentPattern, decimalNegativePattern, decimalPattern, decimalPositivePattern, doubleNegativePattern, doublePattern, doublePositivePattern, integerNegativePattern, integerPattern, integerPositivePattern, iriRefPattern, langTagPattern, nilPattern, pNameLnPattern, pNameNsPattern, stringLiteral1Pattern, stringLiteral2Pattern, stringLiteralLong1Pattern, stringLiteralLong2Pattern, var1Pattern, var2Pattern, wsPattern, } from './lexerPatterns.js';
/**
...
export const allTerminals = LexerBuilder.create().add(iriRef, pNameNs, pNameLn, blankNodeLabel, var1, var2, langTag, double, decimal, integer, doublePositive, decimalPositive, integerPositive, doubleNegative, decimalNegative, integerNegative, stringLiteralLong1, stringLiteralLong2, stringLiteral1, stringLiteral2, ws, comment, nil, anon);
