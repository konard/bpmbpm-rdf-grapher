 ...
 */
export function queryProjectionIsGood(query) {
    ...
    if (subqueries.length > 0) {
        const selectBoundedVars = new Set();
...
export function findPatternBoundedVars(op, boundedVars) {
    function recurse(x) {
 ...
 */
export function checkNote13(patterns) {
 ...
 */
export function updateNoReuseBlankNodeLabels(updateQuery) {
    const blankLabelsUsedInInsertData = new Set();
