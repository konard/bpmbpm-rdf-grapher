...
export function funcExpr1(func) {
    return {
...
export function funcExpr2(func) {
    return {
        name: unCapitalize(func.name),
...
export function funcExpr3(func) {
    return {
        name: unCapitalize(func.name),
...
export function funcExprOrNil1(func) {
    return {
        name: unCapitalize(func.name),
...
export function funcExprList1(func) {
    return {
        name: unCapitalize(func.name),
...
export function funcExpr2or3(func) {
    return {
        name: unCapitalize(func.name),
...
export function funcExpr3or4(func) {
    return {
        name: unCapitalize(func.name),
...
export function funcGroupGraphPattern(func) {
    return {
        name: unCapitalize(func.name),
        impl: ({ ACTION, SUBRULE, CONSUME }) => (C) => {
            const operator = CONSUME(func);
...
export function baseAggregateFunc(func) {
    return {
        name: unCapitalize(func.name),
