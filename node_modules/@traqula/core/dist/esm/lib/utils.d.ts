 ...
 */
export declare const traqulaIndentation: "When you use this string, you expect traqula to handle indentation after every newline";
/**
 ...
 */
export declare const traqulaNewlineAlternative: "When you use this string, you expect that the core generator of Traqula does prints a given string instead of a ewline when NEW_LINE printing is disabled through traqulaIndentation";
