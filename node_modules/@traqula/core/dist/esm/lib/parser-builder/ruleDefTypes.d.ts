import type { AtLeastOneSepMethodOpts, DSLMethodOpts, DSLMethodOptsWithErr, GrammarAction, IOrAlt, ManySepMethodOpts, OrMethodOpts, ConsumeMethodOpts, IToken, TokenType } from '@traqula/chevrotain';
/**
 ...
 */
type SubRuleFunc = <T extends string, U = unknown, ARGS extends any[] = any>(cstDef: ParserRule<any, T, U, ARGS>, ...argument: ARGS) => U;
/**
 * Type definition used by {@link CstDef.BACKTRACK}.
 */
type BacktrackFunc = <T extends string, U = unknown, ARGS extends any[] = any>(cstDef: ParserRule<any, T, U, ARGS>, ...argument: ARGS) => () => boolean;
/**
