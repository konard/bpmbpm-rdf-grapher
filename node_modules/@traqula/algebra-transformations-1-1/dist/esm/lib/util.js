 ...
 */
export function resolveIRI(iri, base) {
 ...
 */
export function objectify(algebra) {
    if (algebra.termType) {
        ...
        const result = { termType: algebra.termType, value: algebra.value };
        if (algebra.language) {
 ...
 */
export function inScopeVariables(op, visitor = visitOperation) {
    const variables = {};
    ...
    function visitingRecursion(curOp) {
