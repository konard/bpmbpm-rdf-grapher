...
export declare function createAstContext(): AstContext;
export type AstIndir<Name extends string, Ret, Arg extends any[]> = IndirDef<AstContext, Name, Ret, Arg>;
export declare const eTypes: typeof Algebra.ExpressionTypes;
export declare const resetContext: AstIndir<'resetContext', void, []>;
export declare const registerProjection: AstIndir<'registerProjection', void, [Algebra.Operation]>;
