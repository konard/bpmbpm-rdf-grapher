...
import { translateAlgPatternIntoGroup, } from './pattern.js';
import { removeAlgQuads } from './quads.js';
import { toUpdate, translateAlgCompositeUpdate, translateAlgUpdateOperation, } from './updateUnit.js';
export const algToSparql = {
    name: 'algToSparql',
    fun: ({ SUBRULE }) => (_, op) => {
