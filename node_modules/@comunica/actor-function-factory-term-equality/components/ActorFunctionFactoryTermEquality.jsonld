{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-equality",
  "components": [
    {
      "@id": "caffte:components/ActorFunctionFactoryTermEquality.jsonld#ActorFunctionFactoryTermEquality",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermEquality",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionEquality Function Factory Actor.",
      "parameters": [
        {
          "@id": "caffte:components/ActorFunctionFactoryTermEquality.jsonld#ActorFunctionFactoryTermEquality_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caffte:components/ActorFunctionFactoryTermEquality.jsonld#ActorFunctionFactoryTermEquality_args_bus",
          "range": {
        ...
        {
          "@id": "caffte:components/ActorFunctionFactoryTermEquality.jsonld#ActorFunctionFactoryTermEquality_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caffte:components/ActorFunctionFactoryTermEquality.jsonld#ActorFunctionFactoryTermEquality_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caffte:components/ActorFunctionFactoryTermEquality.jsonld#ActorFunctionFactoryTermEquality__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caffte:components/ActorFunctionFactoryTermEquality.jsonld#ActorFunctionFactoryTermEquality__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caffte:components/ActorFunctionFactoryTermEquality.jsonld#ActorFunctionFactoryTermEquality_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
