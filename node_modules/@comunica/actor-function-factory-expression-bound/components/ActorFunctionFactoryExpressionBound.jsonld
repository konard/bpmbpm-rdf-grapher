{
  ...
  "@id": "npmd:@comunica/actor-function-factory-expression-bound",
  "components": [
    {
      "@id": "caffeb:components/ActorFunctionFactoryExpressionBound.jsonld#ActorFunctionFactoryExpressionBound",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryExpressionBound",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica ExpressionFunctionBound Function Factory Actor.",
      "parameters": [
        {
          "@id": "caffeb:components/ActorFunctionFactoryExpressionBound.jsonld#ActorFunctionFactoryExpressionBound_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caffeb:components/ActorFunctionFactoryExpressionBound.jsonld#ActorFunctionFactoryExpressionBound_args_bus",
          "range": {
        ...
        {
          "@id": "caffeb:components/ActorFunctionFactoryExpressionBound.jsonld#ActorFunctionFactoryExpressionBound_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caffeb:components/ActorFunctionFactoryExpressionBound.jsonld#ActorFunctionFactoryExpressionBound_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caffeb:components/ActorFunctionFactoryExpressionBound.jsonld#ActorFunctionFactoryExpressionBound__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caffeb:components/ActorFunctionFactoryExpressionBound.jsonld#ActorFunctionFactoryExpressionBound__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caffeb:components/ActorFunctionFactoryExpressionBound.jsonld#ActorFunctionFactoryExpressionBound_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
