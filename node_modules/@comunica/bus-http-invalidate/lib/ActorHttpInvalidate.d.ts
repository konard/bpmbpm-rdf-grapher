 ...
 */
export declare abstract class ActorHttpInvalidate<TS = undefined> extends Actor<IActionHttpInvalidate, IActorTest, IActorHttpInvalidateOutput, TS> {
    /**
     * @param args -
     ...
     */
    constructor(args: IActorHttpInvalidateArgs<TS>);
}
...
export type IActorHttpInvalidateArgs<TS = undefined> = IActorArgs<IActionHttpInvalidate, IActorTest, IActorHttpInvalidateOutput, TS>;
