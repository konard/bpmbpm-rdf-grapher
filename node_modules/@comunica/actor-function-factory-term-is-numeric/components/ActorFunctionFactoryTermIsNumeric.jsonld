{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-is-numeric",
  "components": [
    {
      "@id": "cafftin:components/ActorFunctionFactoryTermIsNumeric.jsonld#ActorFunctionFactoryTermIsNumeric",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermIsNumeric",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionIsNumeric Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftin:components/ActorFunctionFactoryTermIsNumeric.jsonld#ActorFunctionFactoryTermIsNumeric_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftin:components/ActorFunctionFactoryTermIsNumeric.jsonld#ActorFunctionFactoryTermIsNumeric_args_bus",
          "range": {
        ...
        {
          "@id": "cafftin:components/ActorFunctionFactoryTermIsNumeric.jsonld#ActorFunctionFactoryTermIsNumeric_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftin:components/ActorFunctionFactoryTermIsNumeric.jsonld#ActorFunctionFactoryTermIsNumeric_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftin:components/ActorFunctionFactoryTermIsNumeric.jsonld#ActorFunctionFactoryTermIsNumeric__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftin:components/ActorFunctionFactoryTermIsNumeric.jsonld#ActorFunctionFactoryTermIsNumeric__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftin:components/ActorFunctionFactoryTermIsNumeric.jsonld#ActorFunctionFactoryTermIsNumeric_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
