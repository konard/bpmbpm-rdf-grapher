 ...
 */
export declare abstract class ActorOptimizeQueryOperation<TS = undefined> extends Actor<IActionOptimizeQueryOperation, IActorTest, IActorOptimizeQueryOperationOutput, TS> {
    /**
     * @param args -
     *   \ @defaultNested {<default_bus> a <cc:components/Bus.jsonld#Bus>} bus
     *   \ @defaultNested {Query optimization failed: none of the configured actors were able to optimize} busFailMessage
     */
    constructor(args: IActorOptimizeQueryOperationArgs<TS>);
}
...
export type IActorOptimizeQueryOperationArgs<TS = undefined> = IActorArgs<IActionOptimizeQueryOperation, IActorTest, IActorOptimizeQueryOperationOutput, TS>;
export type MediatorOptimizeQueryOperation = Mediate<IActionOptimizeQueryOperation, IActorOptimizeQueryOperationOutput>;
