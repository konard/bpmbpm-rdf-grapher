{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-encode-for-uri",
  "components": [
    {
      "@id": "cafftefu:components/ActorFunctionFactoryTermEncodeForUri.jsonld#ActorFunctionFactoryTermEncodeForUri",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermEncodeForUri",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionEncodeForUri Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftefu:components/ActorFunctionFactoryTermEncodeForUri.jsonld#ActorFunctionFactoryTermEncodeForUri_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftefu:components/ActorFunctionFactoryTermEncodeForUri.jsonld#ActorFunctionFactoryTermEncodeForUri_args_bus",
          "range": {
        ...
        {
          "@id": "cafftefu:components/ActorFunctionFactoryTermEncodeForUri.jsonld#ActorFunctionFactoryTermEncodeForUri_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftefu:components/ActorFunctionFactoryTermEncodeForUri.jsonld#ActorFunctionFactoryTermEncodeForUri_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftefu:components/ActorFunctionFactoryTermEncodeForUri.jsonld#ActorFunctionFactoryTermEncodeForUri__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftefu:components/ActorFunctionFactoryTermEncodeForUri.jsonld#ActorFunctionFactoryTermEncodeForUri__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftefu:components/ActorFunctionFactoryTermEncodeForUri.jsonld#ActorFunctionFactoryTermEncodeForUri_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
