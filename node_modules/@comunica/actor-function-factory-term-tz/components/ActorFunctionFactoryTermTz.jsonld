{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-tz",
  "components": [
    {
      "@id": "cafftt:components/ActorFunctionFactoryTermTz.jsonld#ActorFunctionFactoryTermTz",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermTz",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionTz Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTz.jsonld#ActorFunctionFactoryTermTz_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTz.jsonld#ActorFunctionFactoryTermTz_args_bus",
          "range": {
        ...
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTz.jsonld#ActorFunctionFactoryTermTz_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTz.jsonld#ActorFunctionFactoryTermTz_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTz.jsonld#ActorFunctionFactoryTermTz__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTz.jsonld#ActorFunctionFactoryTermTz__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTz.jsonld#ActorFunctionFactoryTermTz_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
