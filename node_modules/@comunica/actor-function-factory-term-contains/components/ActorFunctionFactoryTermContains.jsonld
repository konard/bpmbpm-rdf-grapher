{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-contains",
  "components": [
    {
      "@id": "cafftc:components/ActorFunctionFactoryTermContains.jsonld#ActorFunctionFactoryTermContains",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermContains",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionContains Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermContains.jsonld#ActorFunctionFactoryTermContains_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermContains.jsonld#ActorFunctionFactoryTermContains_args_bus",
          "range": {
        ...
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermContains.jsonld#ActorFunctionFactoryTermContains_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermContains.jsonld#ActorFunctionFactoryTermContains_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermContains.jsonld#ActorFunctionFactoryTermContains__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermContains.jsonld#ActorFunctionFactoryTermContains__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermContains.jsonld#ActorFunctionFactoryTermContains_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
