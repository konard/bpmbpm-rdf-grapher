 ...
 */
export declare abstract class ActorQueryProcess<TS = undefined> extends Actor<IActionQueryProcess, IActorTest, IActorQueryProcessOutput, TS> {
    /**
     * @param args -
     ...
     */
    constructor(args: IActorQueryProcessArgs<TS>);
}
...
export type IActorQueryProcessArgs<TS = undefined> = IActorArgs<IActionQueryProcess, IActorTest, IActorQueryProcessOutput, TS>;
export type MediatorQueryProcess = Mediate<IActionQueryProcess, IActorQueryProcessOutput>;
