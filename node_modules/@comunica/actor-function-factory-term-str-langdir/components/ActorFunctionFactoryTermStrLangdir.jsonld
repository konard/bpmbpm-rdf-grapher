{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-str-langdir",
  "components": [
    {
      "@id": "cafftsl:components/ActorFunctionFactoryTermStrLangdir.jsonld#ActorFunctionFactoryTermStrLangdir",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermStrLangdir",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionStrLang Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLangdir.jsonld#ActorFunctionFactoryTermStrLangdir_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLangdir.jsonld#ActorFunctionFactoryTermStrLangdir_args_bus",
          "range": {
        ...
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLangdir.jsonld#ActorFunctionFactoryTermStrLangdir_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLangdir.jsonld#ActorFunctionFactoryTermStrLangdir_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLangdir.jsonld#ActorFunctionFactoryTermStrLangdir__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLangdir.jsonld#ActorFunctionFactoryTermStrLangdir__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLangdir.jsonld#ActorFunctionFactoryTermStrLangdir_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
