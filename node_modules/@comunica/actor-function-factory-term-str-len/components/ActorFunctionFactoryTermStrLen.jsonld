{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-str-len",
  "components": [
    {
      "@id": "cafftsl:components/ActorFunctionFactoryTermStrLen.jsonld#ActorFunctionFactoryTermStrLen",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermStrLen",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionStrLen Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLen.jsonld#ActorFunctionFactoryTermStrLen_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLen.jsonld#ActorFunctionFactoryTermStrLen_args_bus",
          "range": {
        ...
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLen.jsonld#ActorFunctionFactoryTermStrLen_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLen.jsonld#ActorFunctionFactoryTermStrLen_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLen.jsonld#ActorFunctionFactoryTermStrLen__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLen.jsonld#ActorFunctionFactoryTermStrLen__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftsl:components/ActorFunctionFactoryTermStrLen.jsonld#ActorFunctionFactoryTermStrLen_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
