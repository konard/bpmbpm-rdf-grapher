{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-str-before",
  "components": [
    {
      "@id": "cafftsb:components/ActorFunctionFactoryTermStrBefore.jsonld#ActorFunctionFactoryTermStrBefore",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermStrBefore",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionStrBefore Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftsb:components/ActorFunctionFactoryTermStrBefore.jsonld#ActorFunctionFactoryTermStrBefore_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftsb:components/ActorFunctionFactoryTermStrBefore.jsonld#ActorFunctionFactoryTermStrBefore_args_bus",
          "range": {
        ...
        {
          "@id": "cafftsb:components/ActorFunctionFactoryTermStrBefore.jsonld#ActorFunctionFactoryTermStrBefore_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftsb:components/ActorFunctionFactoryTermStrBefore.jsonld#ActorFunctionFactoryTermStrBefore_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftsb:components/ActorFunctionFactoryTermStrBefore.jsonld#ActorFunctionFactoryTermStrBefore__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftsb:components/ActorFunctionFactoryTermStrBefore.jsonld#ActorFunctionFactoryTermStrBefore__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftsb:components/ActorFunctionFactoryTermStrBefore.jsonld#ActorFunctionFactoryTermStrBefore_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
