{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-triple",
  "components": [
    {
      "@id": "cafftt:components/ActorFunctionFactoryTermTriple.jsonld#ActorFunctionFactoryTermTriple",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermTriple",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionTriple Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTriple.jsonld#ActorFunctionFactoryTermTriple_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTriple.jsonld#ActorFunctionFactoryTermTriple_args_bus",
          "range": {
        ...
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTriple.jsonld#ActorFunctionFactoryTermTriple_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTriple.jsonld#ActorFunctionFactoryTermTriple_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTriple.jsonld#ActorFunctionFactoryTermTriple__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTriple.jsonld#ActorFunctionFactoryTermTriple__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTriple.jsonld#ActorFunctionFactoryTermTriple_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
