{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-str-dt",
  "components": [
    {
      "@id": "cafftsd:components/ActorFunctionFactoryTermStrDt.jsonld#ActorFunctionFactoryTermStrDt",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermStrDt",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionStrDt Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftsd:components/ActorFunctionFactoryTermStrDt.jsonld#ActorFunctionFactoryTermStrDt_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftsd:components/ActorFunctionFactoryTermStrDt.jsonld#ActorFunctionFactoryTermStrDt_args_bus",
          "range": {
        ...
        {
          "@id": "cafftsd:components/ActorFunctionFactoryTermStrDt.jsonld#ActorFunctionFactoryTermStrDt_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftsd:components/ActorFunctionFactoryTermStrDt.jsonld#ActorFunctionFactoryTermStrDt_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftsd:components/ActorFunctionFactoryTermStrDt.jsonld#ActorFunctionFactoryTermStrDt__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftsd:components/ActorFunctionFactoryTermStrDt.jsonld#ActorFunctionFactoryTermStrDt__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftsd:components/ActorFunctionFactoryTermStrDt.jsonld#ActorFunctionFactoryTermStrDt_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
