{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-seconds",
  "components": [
    {
      "@id": "caffts:components/ActorFunctionFactoryTermSeconds.jsonld#ActorFunctionFactoryTermSeconds",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermSeconds",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionSeconds Function Factory Actor.",
      "parameters": [
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSeconds.jsonld#ActorFunctionFactoryTermSeconds_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSeconds.jsonld#ActorFunctionFactoryTermSeconds_args_bus",
          "range": {
        ...
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSeconds.jsonld#ActorFunctionFactoryTermSeconds_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSeconds.jsonld#ActorFunctionFactoryTermSeconds_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSeconds.jsonld#ActorFunctionFactoryTermSeconds__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSeconds.jsonld#ActorFunctionFactoryTermSeconds__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSeconds.jsonld#ActorFunctionFactoryTermSeconds_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
