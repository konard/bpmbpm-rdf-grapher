...
exports.KeysHttp = {
     ...
     */
    httpAbortSignal: new core_1.ActionContextKey('@comunica/bus-http:http-abort-controller'),
    /**
     ...
     */
    httpCache: new core_1.ActionContextKey('@comunica/bus-http:httpCache'),
};
...
exports.KeysInitQuery = {
     ...
     */
    parseUnsupportedVersions: new core_1.ActionContextKey('@comunica/actor-init-query:parseUnsupportedVersions'),
    /**
     ...
     * The file's base IRI.
     */
    fileBaseIRI: new core_1.ActionContextKey('@comunica/actor-init-query:fileBaseIRI'),
    /**
     ...
     */
    extensionFunctionsAlwaysPushdown: new core_1.ActionContextKey('@comunica/actor-init-query:extensionFunctionsAlwaysPushdown'),
    /**
...
exports.KeysQueryOperation = {
     ...
     */
    serviceSources: new core_1.ActionContextKey('@comunica/bus-query-operation:serviceSources'),
};
...
exports.KeysRdfSerialize = {
    /**
     * Prefixes that will be used by RDF serializers.
     */
    rdfSerializationPrefixes: new core_1.ActionContextKey('@comunica/bus-rdf-serialize:rdfSerializationPrefixes'),
};
