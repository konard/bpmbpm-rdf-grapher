...
export declare const KeysHttp: {
     ...
     */
    httpAbortSignal: ActionContextKey<AbortSignal>;
    /**
     ...
     */
    httpCache: ActionContextKey<boolean>;
};
...
export declare const KeysInitQuery: {
     ...
     */
    parseUnsupportedVersions: ActionContextKey<boolean>;
    /**
     ...
     */
    query: ActionContextKey<Algebra.BaseOperation>;
    /**
     ...
     * The file's base IRI.
     */
    fileBaseIRI: ActionContextKey<string>;
    /**
     ...
     */
    extensionFunctionsAlwaysPushdown: ActionContextKey<boolean>;
    /**
...
export declare const KeysQueryOperation: {
     ...
     */
    operation: ActionContextKey<Algebra.BaseOperation>;
    /**
     ...
     */
    serviceSources: ActionContextKey<Record<string, IQuerySourceWrapper<import("@comunica/types").IQuerySource>>>;
};
...
export declare const KeysRdfSerialize: {
    /**
     * Prefixes that will be used by RDF serializers.
     */
    rdfSerializationPrefixes: ActionContextKey<Record<string, string>>;
};
