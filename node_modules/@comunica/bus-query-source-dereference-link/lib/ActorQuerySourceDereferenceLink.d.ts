 ...
 */
export declare abstract class ActorQuerySourceDereferenceLink<TS = undefined> extends Actor<IActionQuerySourceDereferenceLink, IActorTest, IActorQuerySourceDereferenceLinkOutput, TS> {
    /**
     * @param args -
     ...
     */
    constructor(args: IActorQuerySourceDereferenceLinkArgs<TS>);
}
...
export type IActorQuerySourceDereferenceLinkArgs<TS = undefined> = IActorArgs<IActionQuerySourceDereferenceLink, IActorTest, IActorQuerySourceDereferenceLinkOutput, TS>;
export type MediatorQuerySourceDereferenceLink = Mediate<IActionQuerySourceDereferenceLink, IActorQuerySourceDereferenceLinkOutput>;
