{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-regex",
  "components": [
    {
      "@id": "cafftr:components/ActorFunctionFactoryTermRegex.jsonld#ActorFunctionFactoryTermRegex",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermRegex",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionRegex Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRegex.jsonld#ActorFunctionFactoryTermRegex_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRegex.jsonld#ActorFunctionFactoryTermRegex_args_bus",
          "range": {
        ...
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRegex.jsonld#ActorFunctionFactoryTermRegex_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRegex.jsonld#ActorFunctionFactoryTermRegex_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRegex.jsonld#ActorFunctionFactoryTermRegex__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRegex.jsonld#ActorFunctionFactoryTermRegex__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRegex.jsonld#ActorFunctionFactoryTermRegex_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
