 ...
 */
export declare abstract class ActorQueryParse<TS = undefined> extends Actor<IActionQueryParse, IActorTest, IActorQueryParseOutput, TS> {
    /**
     * @param args -
     ...
     */
    constructor(args: IActorQueryParseArgs<TS>);
}
...
export type IActorQueryParseArgs<TS = undefined> = IActorArgs<IActionQueryParse, IActorTest, IActorQueryParseOutput, TS>;
