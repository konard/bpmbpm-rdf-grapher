{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-xsd-to-date",
  "components": [
    {
      "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDate.jsonld#ActorFunctionFactoryTermXsdToDate",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermXsdToDate",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionXsdToDate Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDate.jsonld#ActorFunctionFactoryTermXsdToDate_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDate.jsonld#ActorFunctionFactoryTermXsdToDate_args_bus",
          "range": {
        ...
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDate.jsonld#ActorFunctionFactoryTermXsdToDate_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDate.jsonld#ActorFunctionFactoryTermXsdToDate_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDate.jsonld#ActorFunctionFactoryTermXsdToDate__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDate.jsonld#ActorFunctionFactoryTermXsdToDate__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDate.jsonld#ActorFunctionFactoryTermXsdToDate_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
