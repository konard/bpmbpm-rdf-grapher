{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-subtraction",
  "components": [
    {
      "@id": "caffts:components/ActorFunctionFactoryTermSubtraction.jsonld#ActorFunctionFactoryTermSubtraction",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermSubtraction",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionSubtraction Function Factory Actor.",
      "parameters": [
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubtraction.jsonld#ActorFunctionFactoryTermSubtraction_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubtraction.jsonld#ActorFunctionFactoryTermSubtraction_args_bus",
          "range": {
        ...
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubtraction.jsonld#ActorFunctionFactoryTermSubtraction_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubtraction.jsonld#ActorFunctionFactoryTermSubtraction_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubtraction.jsonld#ActorFunctionFactoryTermSubtraction__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubtraction.jsonld#ActorFunctionFactoryTermSubtraction__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubtraction.jsonld#ActorFunctionFactoryTermSubtraction_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
