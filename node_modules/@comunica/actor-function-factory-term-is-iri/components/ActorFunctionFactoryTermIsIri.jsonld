{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-is-iri",
  "components": [
    {
      "@id": "cafftii:components/ActorFunctionFactoryTermIsIri.jsonld#ActorFunctionFactoryTermIsIri",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermIsIri",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionIsIri Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftii:components/ActorFunctionFactoryTermIsIri.jsonld#ActorFunctionFactoryTermIsIri_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftii:components/ActorFunctionFactoryTermIsIri.jsonld#ActorFunctionFactoryTermIsIri_args_bus",
          "range": {
        ...
        {
          "@id": "cafftii:components/ActorFunctionFactoryTermIsIri.jsonld#ActorFunctionFactoryTermIsIri_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftii:components/ActorFunctionFactoryTermIsIri.jsonld#ActorFunctionFactoryTermIsIri_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftii:components/ActorFunctionFactoryTermIsIri.jsonld#ActorFunctionFactoryTermIsIri__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftii:components/ActorFunctionFactoryTermIsIri.jsonld#ActorFunctionFactoryTermIsIri__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftii:components/ActorFunctionFactoryTermIsIri.jsonld#ActorFunctionFactoryTermIsIri_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
