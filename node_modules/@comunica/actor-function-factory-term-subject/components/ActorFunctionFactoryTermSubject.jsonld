{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-subject",
  "components": [
    {
      "@id": "caffts:components/ActorFunctionFactoryTermSubject.jsonld#ActorFunctionFactoryTermSubject",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermSubject",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionSubject Function Factory Actor.",
      "parameters": [
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubject.jsonld#ActorFunctionFactoryTermSubject_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubject.jsonld#ActorFunctionFactoryTermSubject_args_bus",
          "range": {
        ...
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubject.jsonld#ActorFunctionFactoryTermSubject_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubject.jsonld#ActorFunctionFactoryTermSubject_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubject.jsonld#ActorFunctionFactoryTermSubject__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubject.jsonld#ActorFunctionFactoryTermSubject__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caffts:components/ActorFunctionFactoryTermSubject.jsonld#ActorFunctionFactoryTermSubject_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
