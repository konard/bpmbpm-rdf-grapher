 ...
 */
export declare function materializeOperation(operation: Algebra.Operation, bindings: Bindings, algebraFactory: AlgebraFactory, bindingsFactory: BindingsFactory, options?: {
