{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-xsd-to-boolean",
  "components": [
    {
      "@id": "cafftxtb:components/ActorFunctionFactoryTermXsdToBoolean.jsonld#ActorFunctionFactoryTermXsdToBoolean",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermXsdToBoolean",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionXsdToBoolean Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftxtb:components/ActorFunctionFactoryTermXsdToBoolean.jsonld#ActorFunctionFactoryTermXsdToBoolean_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftxtb:components/ActorFunctionFactoryTermXsdToBoolean.jsonld#ActorFunctionFactoryTermXsdToBoolean_args_bus",
          "range": {
        ...
        {
          "@id": "cafftxtb:components/ActorFunctionFactoryTermXsdToBoolean.jsonld#ActorFunctionFactoryTermXsdToBoolean_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftxtb:components/ActorFunctionFactoryTermXsdToBoolean.jsonld#ActorFunctionFactoryTermXsdToBoolean_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftxtb:components/ActorFunctionFactoryTermXsdToBoolean.jsonld#ActorFunctionFactoryTermXsdToBoolean__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftxtb:components/ActorFunctionFactoryTermXsdToBoolean.jsonld#ActorFunctionFactoryTermXsdToBoolean__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftxtb:components/ActorFunctionFactoryTermXsdToBoolean.jsonld#ActorFunctionFactoryTermXsdToBoolean_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
