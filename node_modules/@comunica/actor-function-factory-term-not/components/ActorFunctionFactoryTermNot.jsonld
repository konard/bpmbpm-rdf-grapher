{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-not",
  "components": [
    {
      "@id": "cafftn:components/ActorFunctionFactoryTermNot.jsonld#ActorFunctionFactoryTermNot",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermNot",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionNot Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNot.jsonld#ActorFunctionFactoryTermNot_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNot.jsonld#ActorFunctionFactoryTermNot_args_bus",
          "range": {
        ...
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNot.jsonld#ActorFunctionFactoryTermNot_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNot.jsonld#ActorFunctionFactoryTermNot_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNot.jsonld#ActorFunctionFactoryTermNot__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNot.jsonld#ActorFunctionFactoryTermNot__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNot.jsonld#ActorFunctionFactoryTermNot_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
