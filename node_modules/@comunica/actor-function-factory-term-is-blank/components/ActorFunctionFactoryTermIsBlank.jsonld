{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-is-blank",
  "components": [
    {
      "@id": "cafftib:components/ActorFunctionFactoryTermIsBlank.jsonld#ActorFunctionFactoryTermIsBlank",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermIsBlank",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionIsBlank Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftib:components/ActorFunctionFactoryTermIsBlank.jsonld#ActorFunctionFactoryTermIsBlank_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftib:components/ActorFunctionFactoryTermIsBlank.jsonld#ActorFunctionFactoryTermIsBlank_args_bus",
          "range": {
        ...
        {
          "@id": "cafftib:components/ActorFunctionFactoryTermIsBlank.jsonld#ActorFunctionFactoryTermIsBlank_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftib:components/ActorFunctionFactoryTermIsBlank.jsonld#ActorFunctionFactoryTermIsBlank_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftib:components/ActorFunctionFactoryTermIsBlank.jsonld#ActorFunctionFactoryTermIsBlank__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftib:components/ActorFunctionFactoryTermIsBlank.jsonld#ActorFunctionFactoryTermIsBlank__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftib:components/ActorFunctionFactoryTermIsBlank.jsonld#ActorFunctionFactoryTermIsBlank_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
