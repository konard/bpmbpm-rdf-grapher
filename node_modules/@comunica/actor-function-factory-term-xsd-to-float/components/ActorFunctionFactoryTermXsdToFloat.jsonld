{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-xsd-to-float",
  "components": [
    {
      "@id": "cafftxtf:components/ActorFunctionFactoryTermXsdToFloat.jsonld#ActorFunctionFactoryTermXsdToFloat",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermXsdToFloat",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionXsdToFloat Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftxtf:components/ActorFunctionFactoryTermXsdToFloat.jsonld#ActorFunctionFactoryTermXsdToFloat_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftxtf:components/ActorFunctionFactoryTermXsdToFloat.jsonld#ActorFunctionFactoryTermXsdToFloat_args_bus",
          "range": {
        ...
        {
          "@id": "cafftxtf:components/ActorFunctionFactoryTermXsdToFloat.jsonld#ActorFunctionFactoryTermXsdToFloat_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftxtf:components/ActorFunctionFactoryTermXsdToFloat.jsonld#ActorFunctionFactoryTermXsdToFloat_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftxtf:components/ActorFunctionFactoryTermXsdToFloat.jsonld#ActorFunctionFactoryTermXsdToFloat__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftxtf:components/ActorFunctionFactoryTermXsdToFloat.jsonld#ActorFunctionFactoryTermXsdToFloat__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftxtf:components/ActorFunctionFactoryTermXsdToFloat.jsonld#ActorFunctionFactoryTermXsdToFloat_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
