{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-timezone",
  "components": [
    {
      "@id": "cafftt:components/ActorFunctionFactoryTermTimezone.jsonld#ActorFunctionFactoryTermTimezone",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermTimezone",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionTimezone Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTimezone.jsonld#ActorFunctionFactoryTermTimezone_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTimezone.jsonld#ActorFunctionFactoryTermTimezone_args_bus",
          "range": {
        ...
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTimezone.jsonld#ActorFunctionFactoryTermTimezone_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTimezone.jsonld#ActorFunctionFactoryTermTimezone_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTimezone.jsonld#ActorFunctionFactoryTermTimezone__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTimezone.jsonld#ActorFunctionFactoryTermTimezone__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftt:components/ActorFunctionFactoryTermTimezone.jsonld#ActorFunctionFactoryTermTimezone_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
