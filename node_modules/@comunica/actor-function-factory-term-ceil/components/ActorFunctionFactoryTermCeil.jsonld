{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-ceil",
  "components": [
    {
      "@id": "cafftc:components/ActorFunctionFactoryTermCeil.jsonld#ActorFunctionFactoryTermCeil",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermCeil",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionCeil Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermCeil.jsonld#ActorFunctionFactoryTermCeil_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermCeil.jsonld#ActorFunctionFactoryTermCeil_args_bus",
          "range": {
        ...
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermCeil.jsonld#ActorFunctionFactoryTermCeil_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermCeil.jsonld#ActorFunctionFactoryTermCeil_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermCeil.jsonld#ActorFunctionFactoryTermCeil__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermCeil.jsonld#ActorFunctionFactoryTermCeil__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftc:components/ActorFunctionFactoryTermCeil.jsonld#ActorFunctionFactoryTermCeil_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
