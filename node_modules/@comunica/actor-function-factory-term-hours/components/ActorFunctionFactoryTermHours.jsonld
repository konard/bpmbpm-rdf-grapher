{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-hours",
  "components": [
    {
      "@id": "caffth:components/ActorFunctionFactoryTermHours.jsonld#ActorFunctionFactoryTermHours",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermHours",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionHours Function Factory Actor.",
      "parameters": [
        {
          "@id": "caffth:components/ActorFunctionFactoryTermHours.jsonld#ActorFunctionFactoryTermHours_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caffth:components/ActorFunctionFactoryTermHours.jsonld#ActorFunctionFactoryTermHours_args_bus",
          "range": {
        ...
        {
          "@id": "caffth:components/ActorFunctionFactoryTermHours.jsonld#ActorFunctionFactoryTermHours_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caffth:components/ActorFunctionFactoryTermHours.jsonld#ActorFunctionFactoryTermHours_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caffth:components/ActorFunctionFactoryTermHours.jsonld#ActorFunctionFactoryTermHours__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caffth:components/ActorFunctionFactoryTermHours.jsonld#ActorFunctionFactoryTermHours__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caffth:components/ActorFunctionFactoryTermHours.jsonld#ActorFunctionFactoryTermHours_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
