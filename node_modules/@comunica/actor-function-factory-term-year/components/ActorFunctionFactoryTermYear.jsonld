{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-year",
  "components": [
    {
      "@id": "caffty:components/ActorFunctionFactoryTermYear.jsonld#ActorFunctionFactoryTermYear",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermYear",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionYear Function Factory Actor.",
      "parameters": [
        {
          "@id": "caffty:components/ActorFunctionFactoryTermYear.jsonld#ActorFunctionFactoryTermYear_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caffty:components/ActorFunctionFactoryTermYear.jsonld#ActorFunctionFactoryTermYear_args_bus",
          "range": {
        ...
        {
          "@id": "caffty:components/ActorFunctionFactoryTermYear.jsonld#ActorFunctionFactoryTermYear_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caffty:components/ActorFunctionFactoryTermYear.jsonld#ActorFunctionFactoryTermYear_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caffty:components/ActorFunctionFactoryTermYear.jsonld#ActorFunctionFactoryTermYear__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caffty:components/ActorFunctionFactoryTermYear.jsonld#ActorFunctionFactoryTermYear__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caffty:components/ActorFunctionFactoryTermYear.jsonld#ActorFunctionFactoryTermYear_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
