...
const Errors_1 = require("@comunica/utils-expression-evaluator/lib/util/Errors");
/**
    ...
    constructor() {
        super({
            ...
            overloads: (0, utils_expression_evaluator_1.declare)(utils_expression_evaluator_1.SparqlOperator.STRAFTER)
                ...
                .onBinary([utils_expression_evaluator_1.TypeURL.RDF_DIR_LANG_STRING, utils_expression_evaluator_1.TypeURL.XSD_STRING], () => (arg1, arg2) => {
                const [a1, a2] = [arg1.typedValue, arg2.typedValue];
                const sub = a1.slice(a1.indexOf(a2)).slice(a2.length);
                return sub || !a2 ? (0, Helpers_1.dirLangString)(sub, arg1.language, arg1.direction) : (0, utils_expression_evaluator_1.string)(sub);
            })
                .onBinary([utils_expression_evaluator_1.TypeURL.RDF_DIR_LANG_STRING, utils_expression_evaluator_1.TypeURL.RDF_LANG_STRING], () => (arg1, arg2) => {
                if (arg1.language !== arg2.language) {
                    throw new utils_expression_evaluator_1.IncompatibleLanguageOperation(arg1, arg2);
                }
                const [a1, a2] = [arg1.typedValue, arg2.typedValue];
                ...
                .onBinary([utils_expression_evaluator_1.TypeURL.RDF_DIR_LANG_STRING, utils_expression_evaluator_1.TypeURL.RDF_DIR_LANG_STRING], () => (arg1, arg2) => {
                if (arg1.language !== arg2.language) {
                    throw new utils_expression_evaluator_1.IncompatibleLanguageOperation(arg1, arg2);
                }
                if (arg1.direction !== arg2.direction) {
                    throw new Errors_1.IncompatibleDirectionalLanguageOperation(arg1, arg2);
                }
                const [a1, a2] = [arg1.typedValue, arg2.typedValue];
                const sub = a1.slice(a1.indexOf(a2)).slice(a2.length);
                return sub || !a2 ? (0, Helpers_1.dirLangString)(sub, arg1.language, arg1.direction) : (0, utils_expression_evaluator_1.string)(sub);
