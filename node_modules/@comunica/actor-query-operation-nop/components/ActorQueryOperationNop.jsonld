  ...
  "components": [
    {
      ...
      "@type": "Class",
      "requireElement": "ActorQueryOperationNop",
      "extends": [
        {
      ...
      "comment": "A [Query Operation](https://github.com/comunica/comunica/tree/master/packages/bus-query-operation) actor that handles SPARQL nop operations.",
      "parameters": [
        {
          "@id": "caqon:components/ActorQueryOperationNop.jsonld#ActorQueryOperationNop_args_mediatorMergeBindingsContext",
      ...
      "memberFields": [
        {
          "@id": "caqon:components/ActorQueryOperationNop.jsonld#ActorQueryOperationNop__member_mediatorMergeBindingsContext",
          "memberFieldName": "mediatorMergeBindingsContext",
          "range": "cc:components/Mediator.jsonld#Mediator"
        },
        {
          "@id": "caqon:components/ActorQueryOperationNop.jsonld#ActorQueryOperationNop__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caqon:components/ActorQueryOperationNop.jsonld#ActorQueryOperationNop__member_testOperation",
          "memberFieldName": "testOperation"
        },
        {
          "@id": "caqon:components/ActorQueryOperationNop.jsonld#ActorQueryOperationNop__member_runOperation",
          "memberFieldName": "runOperation"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caqon:components/ActorQueryOperationNop.jsonld#ActorQueryOperationNop_args__constructorArgument",
          "fields": [
            {
    ...
    {
      "@id": "caqon:components/ActorQueryOperationNop.jsonld#IActorQueryOperationNopArgs",
      "@type": "AbstractClass",
      "requireElement": "IActorQueryOperationNopArgs",
      "extends": [
      ...
      "memberFields": [
        {
          "@id": "caqon:components/ActorQueryOperationNop.jsonld#IActorQueryOperationNopArgs__member_mediatorMergeBindingsContext",
          "memberFieldName": "mediatorMergeBindingsContext"
        }
      ],
      "constructorArguments": []
