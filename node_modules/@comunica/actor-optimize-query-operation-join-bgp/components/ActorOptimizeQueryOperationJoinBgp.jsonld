{
  ...
  "@id": "npmd:@comunica/actor-optimize-query-operation-join-bgp",
  "components": [
    {
      "@id": "caoqojb:components/ActorOptimizeQueryOperationJoinBgp.jsonld#ActorOptimizeQueryOperationJoinBgp",
      "@type": "Class",
      "requireElement": "ActorOptimizeQueryOperationJoinBgp",
      "extends": [
        "cboqo:components/ActorOptimizeQueryOperation.jsonld#ActorOptimizeQueryOperation"
      ],
      "comment": "A comunica Join BGP Optimize Query Operation Actor.",
      "parameters": [
        {
          "@id": "caoqojb:components/ActorOptimizeQueryOperationJoinBgp.jsonld#ActorOptimizeQueryOperationJoinBgp_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caoqojb:components/ActorOptimizeQueryOperationJoinBgp.jsonld#ActorOptimizeQueryOperationJoinBgp_args_bus",
          "range": {
        ...
        {
          "@id": "caoqojb:components/ActorOptimizeQueryOperationJoinBgp.jsonld#ActorOptimizeQueryOperationJoinBgp_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caoqojb:components/ActorOptimizeQueryOperationJoinBgp.jsonld#ActorOptimizeQueryOperationJoinBgp_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caoqojb:components/ActorOptimizeQueryOperationJoinBgp.jsonld#ActorOptimizeQueryOperationJoinBgp__member_test",
          "memberFieldName": "test"
        },
        {
          "@id": "caoqojb:components/ActorOptimizeQueryOperationJoinBgp.jsonld#ActorOptimizeQueryOperationJoinBgp__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caoqojb:components/ActorOptimizeQueryOperationJoinBgp.jsonld#ActorOptimizeQueryOperationJoinBgp_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
