{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-predicate",
  "components": [
    {
      "@id": "cafftp:components/ActorFunctionFactoryTermPredicate.jsonld#ActorFunctionFactoryTermPredicate",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermPredicate",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionPredicate Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftp:components/ActorFunctionFactoryTermPredicate.jsonld#ActorFunctionFactoryTermPredicate_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftp:components/ActorFunctionFactoryTermPredicate.jsonld#ActorFunctionFactoryTermPredicate_args_bus",
          "range": {
        ...
        {
          "@id": "cafftp:components/ActorFunctionFactoryTermPredicate.jsonld#ActorFunctionFactoryTermPredicate_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftp:components/ActorFunctionFactoryTermPredicate.jsonld#ActorFunctionFactoryTermPredicate_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftp:components/ActorFunctionFactoryTermPredicate.jsonld#ActorFunctionFactoryTermPredicate__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftp:components/ActorFunctionFactoryTermPredicate.jsonld#ActorFunctionFactoryTermPredicate__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftp:components/ActorFunctionFactoryTermPredicate.jsonld#ActorFunctionFactoryTermPredicate_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
