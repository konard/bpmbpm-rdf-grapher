{
  ...
  "@id": "npmd:@comunica/actor-rdf-serialize-n3",
  "components": [
    {
      "@id": "carsn:components/ActorRdfSerializeN3.jsonld#ActorRdfSerializeN3",
      "@type": "Class",
      "requireElement": "ActorRdfSerializeN3",
      "extends": [
        "cbrs:components/ActorRdfSerializeFixedMediaTypes.jsonld#ActorRdfSerializeFixedMediaTypes"
      ],
      "comment": "A comunica N3 RDF Serialize Actor.",
      "parameters": [
        {
          "@id": "carsn:components/ActorRdfSerializeN3.jsonld#ActorRdfSerializeN3_args_mediaTypePriorities",
          "range": "rdf:JSON",
          "default": {
            "@type": "@json",
            "@value": {
        ...
        {
          "@id": "carsn:components/ActorRdfSerializeN3.jsonld#ActorRdfSerializeN3_args_mediaTypeFormats",
          "range": "rdf:JSON",
          "default": {
            "@type": "@json",
            "@value": {
        ...
        {
          "@id": "carsn:components/ActorRdfSerializeN3.jsonld#ActorRdfSerializeN3_args_priorityScale",
          "range": {
        ...
        {
          "@id": "carsn:components/ActorRdfSerializeN3.jsonld#ActorRdfSerializeN3_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "carsn:components/ActorRdfSerializeN3.jsonld#ActorRdfSerializeN3_args_bus",
          "range": {
        ...
        {
          "@id": "carsn:components/ActorRdfSerializeN3.jsonld#ActorRdfSerializeN3_args_busFailMessage",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              "xsd:string",
        ...
        {
          "@id": "carsn:components/ActorRdfSerializeN3.jsonld#ActorRdfSerializeN3_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "carsn:components/ActorRdfSerializeN3.jsonld#ActorRdfSerializeN3__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "carsn:components/ActorRdfSerializeN3.jsonld#ActorRdfSerializeN3__member_runHandle",
          "memberFieldName": "runHandle"
        }
      ],
      "constructorArguments": [
        {
          "@id": "carsn:components/ActorRdfSerializeN3.jsonld#ActorRdfSerializeN3_args__constructorArgument",
          "fields": [
            {
