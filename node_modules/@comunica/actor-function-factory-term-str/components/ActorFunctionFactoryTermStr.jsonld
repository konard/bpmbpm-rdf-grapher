{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-str",
  "components": [
    {
      "@id": "caffts:components/ActorFunctionFactoryTermStr.jsonld#ActorFunctionFactoryTermStr",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermStr",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionStr Function Factory Actor.",
      "parameters": [
        {
          "@id": "caffts:components/ActorFunctionFactoryTermStr.jsonld#ActorFunctionFactoryTermStr_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caffts:components/ActorFunctionFactoryTermStr.jsonld#ActorFunctionFactoryTermStr_args_bus",
          "range": {
        ...
        {
          "@id": "caffts:components/ActorFunctionFactoryTermStr.jsonld#ActorFunctionFactoryTermStr_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caffts:components/ActorFunctionFactoryTermStr.jsonld#ActorFunctionFactoryTermStr_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caffts:components/ActorFunctionFactoryTermStr.jsonld#ActorFunctionFactoryTermStr__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caffts:components/ActorFunctionFactoryTermStr.jsonld#ActorFunctionFactoryTermStr__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caffts:components/ActorFunctionFactoryTermStr.jsonld#ActorFunctionFactoryTermStr_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
