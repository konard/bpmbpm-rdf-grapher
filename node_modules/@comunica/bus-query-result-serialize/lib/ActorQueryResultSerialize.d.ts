...
export type IActorOutputQueryResultSerializeHandle = IActorOutputAbstractMediaTypedHandle<IActorQueryResultSerializeOutput>;
...
export type IActorQueryResultSerializeArgs = IActorArgsMediaTyped<IActionSparqlSerialize, IActorTest, IActorQueryResultSerializeOutput>;
export type MediatorQueryResultSerializeHandle = Mediate<IActionQueryResultSerializeHandle, IActorOutputQueryResultSerializeHandle, IActorTestQueryResultSerializeHandle>;
export type MediatorQueryResultSerializeMediaTypes = Mediate<IActionQueryResultSerializeMediaTypes, IActorOutputQueryResultSerializeMediaTypes, IActorTestQueryResultSerializeMediaTypes>;
export type MediatorQueryResultSerializeMediaTypeFormats = Mediate<IActionQueryResultSerializeMediaTypeFormats, IActorOutputQueryResultSerializeMediaTypeFormats, IActorTestQueryResultSerializeMediaTypeFormats>;
