{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-iri",
  "components": [
    {
      "@id": "caffti:components/ActorFunctionFactoryTermIri.jsonld#ActorFunctionFactoryTermIri",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermIri",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionIri Function Factory Actor.",
      "parameters": [
        {
          "@id": "caffti:components/ActorFunctionFactoryTermIri.jsonld#ActorFunctionFactoryTermIri_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caffti:components/ActorFunctionFactoryTermIri.jsonld#ActorFunctionFactoryTermIri_args_bus",
          "range": {
        ...
        {
          "@id": "caffti:components/ActorFunctionFactoryTermIri.jsonld#ActorFunctionFactoryTermIri_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caffti:components/ActorFunctionFactoryTermIri.jsonld#ActorFunctionFactoryTermIri_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caffti:components/ActorFunctionFactoryTermIri.jsonld#ActorFunctionFactoryTermIri__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caffti:components/ActorFunctionFactoryTermIri.jsonld#ActorFunctionFactoryTermIri__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caffti:components/ActorFunctionFactoryTermIri.jsonld#ActorFunctionFactoryTermIri_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
