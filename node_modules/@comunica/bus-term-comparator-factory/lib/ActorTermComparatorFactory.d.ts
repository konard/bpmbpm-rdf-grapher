 ...
 */
export declare abstract class ActorTermComparatorFactory<TS = undefined> extends Actor<IActionTermComparatorFactory, IActorTest, IActorTermComparatorFactoryOutput, TS> {
     ...
     */
    constructor(args: IActorTermComparatorFactoryArgs<TS>);
}
...
export interface IActorTermComparatorFactoryArgs<TS = undefined> extends IActorArgs<IActionTermComparatorFactory, IActorTest, IActorTermComparatorFactoryOutput, TS> {
...
export type MediatorTermComparatorFactory = Mediate<IActionTermComparatorFactory, IActorTermComparatorFactoryOutput>;
