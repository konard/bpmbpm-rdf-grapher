{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-xsd-to-double",
  "components": [
    {
      "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDouble.jsonld#ActorFunctionFactoryTermXsdToDouble",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermXsdToDouble",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionXsdToDouble Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDouble.jsonld#ActorFunctionFactoryTermXsdToDouble_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDouble.jsonld#ActorFunctionFactoryTermXsdToDouble_args_bus",
          "range": {
        ...
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDouble.jsonld#ActorFunctionFactoryTermXsdToDouble_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDouble.jsonld#ActorFunctionFactoryTermXsdToDouble_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDouble.jsonld#ActorFunctionFactoryTermXsdToDouble__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDouble.jsonld#ActorFunctionFactoryTermXsdToDouble__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDouble.jsonld#ActorFunctionFactoryTermXsdToDouble_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
