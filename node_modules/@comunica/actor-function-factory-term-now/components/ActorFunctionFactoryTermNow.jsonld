{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-now",
  "components": [
    {
      "@id": "cafftn:components/ActorFunctionFactoryTermNow.jsonld#ActorFunctionFactoryTermNow",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermNow",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionNow Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNow.jsonld#ActorFunctionFactoryTermNow_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNow.jsonld#ActorFunctionFactoryTermNow_args_bus",
          "range": {
        ...
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNow.jsonld#ActorFunctionFactoryTermNow_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNow.jsonld#ActorFunctionFactoryTermNow_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNow.jsonld#ActorFunctionFactoryTermNow__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNow.jsonld#ActorFunctionFactoryTermNow__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftn:components/ActorFunctionFactoryTermNow.jsonld#ActorFunctionFactoryTermNow_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
