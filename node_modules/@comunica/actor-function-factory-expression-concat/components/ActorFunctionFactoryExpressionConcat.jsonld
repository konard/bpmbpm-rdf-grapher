  ...
  "components": [
    {
      ...
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryExpressionConcat",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica ExpressionFunctionConcat Function Factory Actor.",
      "parameters": [
        {
          "@id": "caffec:components/ActorFunctionFactoryExpressionConcat.jsonld#ActorFunctionFactoryExpressionConcat_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caffec:components/ActorFunctionFactoryExpressionConcat.jsonld#ActorFunctionFactoryExpressionConcat_args_bus",
          "range": {
        ...
        {
          "@id": "caffec:components/ActorFunctionFactoryExpressionConcat.jsonld#ActorFunctionFactoryExpressionConcat_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caffec:components/ActorFunctionFactoryExpressionConcat.jsonld#ActorFunctionFactoryExpressionConcat_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caffec:components/ActorFunctionFactoryExpressionConcat.jsonld#ActorFunctionFactoryExpressionConcat__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caffec:components/ActorFunctionFactoryExpressionConcat.jsonld#ActorFunctionFactoryExpressionConcat__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caffec:components/ActorFunctionFactoryExpressionConcat.jsonld#ActorFunctionFactoryExpressionConcat_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
