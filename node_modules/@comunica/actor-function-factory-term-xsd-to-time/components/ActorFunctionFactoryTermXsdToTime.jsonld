{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-xsd-to-time",
  "components": [
    {
      "@id": "cafftxtt:components/ActorFunctionFactoryTermXsdToTime.jsonld#ActorFunctionFactoryTermXsdToTime",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermXsdToTime",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionXsdToTime Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftxtt:components/ActorFunctionFactoryTermXsdToTime.jsonld#ActorFunctionFactoryTermXsdToTime_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftxtt:components/ActorFunctionFactoryTermXsdToTime.jsonld#ActorFunctionFactoryTermXsdToTime_args_bus",
          "range": {
        ...
        {
          "@id": "cafftxtt:components/ActorFunctionFactoryTermXsdToTime.jsonld#ActorFunctionFactoryTermXsdToTime_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftxtt:components/ActorFunctionFactoryTermXsdToTime.jsonld#ActorFunctionFactoryTermXsdToTime_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftxtt:components/ActorFunctionFactoryTermXsdToTime.jsonld#ActorFunctionFactoryTermXsdToTime__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftxtt:components/ActorFunctionFactoryTermXsdToTime.jsonld#ActorFunctionFactoryTermXsdToTime__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftxtt:components/ActorFunctionFactoryTermXsdToTime.jsonld#ActorFunctionFactoryTermXsdToTime_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
