{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-object",
  "components": [
    {
      "@id": "caffto:components/ActorFunctionFactoryTermObject.jsonld#ActorFunctionFactoryTermObject",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermObject",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionObject Function Factory Actor.",
      "parameters": [
        {
          "@id": "caffto:components/ActorFunctionFactoryTermObject.jsonld#ActorFunctionFactoryTermObject_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caffto:components/ActorFunctionFactoryTermObject.jsonld#ActorFunctionFactoryTermObject_args_bus",
          "range": {
        ...
        {
          "@id": "caffto:components/ActorFunctionFactoryTermObject.jsonld#ActorFunctionFactoryTermObject_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caffto:components/ActorFunctionFactoryTermObject.jsonld#ActorFunctionFactoryTermObject_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caffto:components/ActorFunctionFactoryTermObject.jsonld#ActorFunctionFactoryTermObject__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caffto:components/ActorFunctionFactoryTermObject.jsonld#ActorFunctionFactoryTermObject__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caffto:components/ActorFunctionFactoryTermObject.jsonld#ActorFunctionFactoryTermObject_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
