{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-xsd-to-decimal",
  "components": [
    {
      "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDecimal.jsonld#ActorFunctionFactoryTermXsdToDecimal",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermXsdToDecimal",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionXsdToDecimal Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDecimal.jsonld#ActorFunctionFactoryTermXsdToDecimal_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDecimal.jsonld#ActorFunctionFactoryTermXsdToDecimal_args_bus",
          "range": {
        ...
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDecimal.jsonld#ActorFunctionFactoryTermXsdToDecimal_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDecimal.jsonld#ActorFunctionFactoryTermXsdToDecimal_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDecimal.jsonld#ActorFunctionFactoryTermXsdToDecimal__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDecimal.jsonld#ActorFunctionFactoryTermXsdToDecimal__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftxtd:components/ActorFunctionFactoryTermXsdToDecimal.jsonld#ActorFunctionFactoryTermXsdToDecimal_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
