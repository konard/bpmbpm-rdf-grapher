{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-is-triple",
  "components": [
    {
      "@id": "cafftit:components/ActorFunctionFactoryTermIsTriple.jsonld#ActorFunctionFactoryTermIsTriple",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermIsTriple",
      "extends": [
      ...
      "parameters": [
        {
          "@id": "cafftit:components/ActorFunctionFactoryTermIsTriple.jsonld#ActorFunctionFactoryTermIsTriple_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftit:components/ActorFunctionFactoryTermIsTriple.jsonld#ActorFunctionFactoryTermIsTriple_args_bus",
          "range": {
        ...
        {
          "@id": "cafftit:components/ActorFunctionFactoryTermIsTriple.jsonld#ActorFunctionFactoryTermIsTriple_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftit:components/ActorFunctionFactoryTermIsTriple.jsonld#ActorFunctionFactoryTermIsTriple_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftit:components/ActorFunctionFactoryTermIsTriple.jsonld#ActorFunctionFactoryTermIsTriple__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftit:components/ActorFunctionFactoryTermIsTriple.jsonld#ActorFunctionFactoryTermIsTriple__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftit:components/ActorFunctionFactoryTermIsTriple.jsonld#ActorFunctionFactoryTermIsTriple_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
