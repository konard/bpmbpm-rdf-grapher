{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-xsd-to-string",
  "components": [
    {
      "@id": "cafftxts:components/ActorFunctionFactoryTermXsdToString.jsonld#ActorFunctionFactoryTermXsdToString",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermXsdToString",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionXsdToString Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftxts:components/ActorFunctionFactoryTermXsdToString.jsonld#ActorFunctionFactoryTermXsdToString_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftxts:components/ActorFunctionFactoryTermXsdToString.jsonld#ActorFunctionFactoryTermXsdToString_args_bus",
          "range": {
        ...
        {
          "@id": "cafftxts:components/ActorFunctionFactoryTermXsdToString.jsonld#ActorFunctionFactoryTermXsdToString_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftxts:components/ActorFunctionFactoryTermXsdToString.jsonld#ActorFunctionFactoryTermXsdToString_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftxts:components/ActorFunctionFactoryTermXsdToString.jsonld#ActorFunctionFactoryTermXsdToString__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftxts:components/ActorFunctionFactoryTermXsdToString.jsonld#ActorFunctionFactoryTermXsdToString__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftxts:components/ActorFunctionFactoryTermXsdToString.jsonld#ActorFunctionFactoryTermXsdToString_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
