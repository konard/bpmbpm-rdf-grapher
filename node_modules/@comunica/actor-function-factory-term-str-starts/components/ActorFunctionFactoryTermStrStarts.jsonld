{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-str-starts",
  "components": [
    {
      "@id": "cafftss:components/ActorFunctionFactoryTermStrStarts.jsonld#ActorFunctionFactoryTermStrStarts",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermStrStarts",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionStrStarts Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermStrStarts.jsonld#ActorFunctionFactoryTermStrStarts_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermStrStarts.jsonld#ActorFunctionFactoryTermStrStarts_args_bus",
          "range": {
        ...
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermStrStarts.jsonld#ActorFunctionFactoryTermStrStarts_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermStrStarts.jsonld#ActorFunctionFactoryTermStrStarts_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermStrStarts.jsonld#ActorFunctionFactoryTermStrStarts__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermStrStarts.jsonld#ActorFunctionFactoryTermStrStarts__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermStrStarts.jsonld#ActorFunctionFactoryTermStrStarts_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
