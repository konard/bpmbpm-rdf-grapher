{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-month",
  "components": [
    {
      "@id": "cafftm:components/ActorFunctionFactoryTermMonth.jsonld#ActorFunctionFactoryTermMonth",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermMonth",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionMonth Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMonth.jsonld#ActorFunctionFactoryTermMonth_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMonth.jsonld#ActorFunctionFactoryTermMonth_args_bus",
          "range": {
        ...
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMonth.jsonld#ActorFunctionFactoryTermMonth_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMonth.jsonld#ActorFunctionFactoryTermMonth_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMonth.jsonld#ActorFunctionFactoryTermMonth__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMonth.jsonld#ActorFunctionFactoryTermMonth__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMonth.jsonld#ActorFunctionFactoryTermMonth_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
