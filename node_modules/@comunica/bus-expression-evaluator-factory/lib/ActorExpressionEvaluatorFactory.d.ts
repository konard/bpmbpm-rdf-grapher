 ...
 */
export declare abstract class ActorExpressionEvaluatorFactory<TS = undefined> extends Actor<IActionExpressionEvaluatorFactory, IActorTest, IActorExpressionEvaluatorFactoryOutput, TS> {
     ...
     */
    constructor(args: IActorExpressionEvaluatorFactoryArgs<TS>);
}
...
export interface IActorExpressionEvaluatorFactoryArgs<TS = undefined> extends IActorArgs<IActionExpressionEvaluatorFactory, IActorTest, IActorExpressionEvaluatorFactoryOutput, TS> {
...
export type MediatorExpressionEvaluatorFactory = Mediate<IActionExpressionEvaluatorFactory, IActorExpressionEvaluatorFactoryOutput>;
