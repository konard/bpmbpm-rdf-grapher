{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-round",
  "components": [
    {
      "@id": "cafftr:components/ActorFunctionFactoryTermRound.jsonld#ActorFunctionFactoryTermRound",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermRound",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionRound Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRound.jsonld#ActorFunctionFactoryTermRound_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRound.jsonld#ActorFunctionFactoryTermRound_args_bus",
          "range": {
        ...
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRound.jsonld#ActorFunctionFactoryTermRound_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRound.jsonld#ActorFunctionFactoryTermRound_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRound.jsonld#ActorFunctionFactoryTermRound__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRound.jsonld#ActorFunctionFactoryTermRound__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermRound.jsonld#ActorFunctionFactoryTermRound_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
