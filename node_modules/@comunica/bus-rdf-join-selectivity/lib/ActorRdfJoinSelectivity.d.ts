 ...
 */
export declare abstract class ActorRdfJoinSelectivity<TS = undefined> extends Actor<IActionRdfJoinSelectivity, IMediatorTypeAccuracy, IActorRdfJoinSelectivityOutput, TS> {
    /**
     * @param args -
     ...
     */
    constructor(args: IActorRdfJoinSelectivityArgs<TS>);
}
...
export type IActorRdfJoinSelectivityArgs<TS = undefined> = IActorArgs<IActionRdfJoinSelectivity, IMediatorTypeAccuracy, IActorRdfJoinSelectivityOutput, TS>;
export type MediatorRdfJoinSelectivity = Mediate<IActionRdfJoinSelectivity, IActorRdfJoinSelectivityOutput, IMediatorTypeAccuracy>;
