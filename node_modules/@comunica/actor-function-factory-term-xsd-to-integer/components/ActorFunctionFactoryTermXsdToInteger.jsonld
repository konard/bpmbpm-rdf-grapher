{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-xsd-to-integer",
  "components": [
    {
      "@id": "cafftxti:components/ActorFunctionFactoryTermXsdToInteger.jsonld#ActorFunctionFactoryTermXsdToInteger",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermXsdToInteger",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionXsdToInteger Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftxti:components/ActorFunctionFactoryTermXsdToInteger.jsonld#ActorFunctionFactoryTermXsdToInteger_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftxti:components/ActorFunctionFactoryTermXsdToInteger.jsonld#ActorFunctionFactoryTermXsdToInteger_args_bus",
          "range": {
        ...
        {
          "@id": "cafftxti:components/ActorFunctionFactoryTermXsdToInteger.jsonld#ActorFunctionFactoryTermXsdToInteger_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftxti:components/ActorFunctionFactoryTermXsdToInteger.jsonld#ActorFunctionFactoryTermXsdToInteger_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftxti:components/ActorFunctionFactoryTermXsdToInteger.jsonld#ActorFunctionFactoryTermXsdToInteger__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftxti:components/ActorFunctionFactoryTermXsdToInteger.jsonld#ActorFunctionFactoryTermXsdToInteger__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftxti:components/ActorFunctionFactoryTermXsdToInteger.jsonld#ActorFunctionFactoryTermXsdToInteger_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
