{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-str-uuid",
  "components": [
    {
      "@id": "cafftsu:components/ActorFunctionFactoryTermStrUuid.jsonld#ActorFunctionFactoryTermStrUuid",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermStrUuid",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionStrUuid Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftsu:components/ActorFunctionFactoryTermStrUuid.jsonld#ActorFunctionFactoryTermStrUuid_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftsu:components/ActorFunctionFactoryTermStrUuid.jsonld#ActorFunctionFactoryTermStrUuid_args_bus",
          "range": {
        ...
        {
          "@id": "cafftsu:components/ActorFunctionFactoryTermStrUuid.jsonld#ActorFunctionFactoryTermStrUuid_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftsu:components/ActorFunctionFactoryTermStrUuid.jsonld#ActorFunctionFactoryTermStrUuid_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftsu:components/ActorFunctionFactoryTermStrUuid.jsonld#ActorFunctionFactoryTermStrUuid__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftsu:components/ActorFunctionFactoryTermStrUuid.jsonld#ActorFunctionFactoryTermStrUuid__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftsu:components/ActorFunctionFactoryTermStrUuid.jsonld#ActorFunctionFactoryTermStrUuid_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
