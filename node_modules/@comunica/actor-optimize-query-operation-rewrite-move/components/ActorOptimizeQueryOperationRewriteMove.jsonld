{
  ...
  "@id": "npmd:@comunica/actor-optimize-query-operation-rewrite-move",
  "components": [
    {
      "@id": "caoqorm:components/ActorOptimizeQueryOperationRewriteMove.jsonld#ActorOptimizeQueryOperationRewriteMove",
      "@type": "Class",
      "requireElement": "ActorOptimizeQueryOperationRewriteMove",
      "extends": [
        "cboqo:components/ActorOptimizeQueryOperation.jsonld#ActorOptimizeQueryOperation"
      ],
      "comment": "A comunica Rewrite Move Optimize Query Operation Actor.",
      "parameters": [
        {
          "@id": "caoqorm:components/ActorOptimizeQueryOperationRewriteMove.jsonld#ActorOptimizeQueryOperationRewriteMove_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caoqorm:components/ActorOptimizeQueryOperationRewriteMove.jsonld#ActorOptimizeQueryOperationRewriteMove_args_bus",
          "range": {
        ...
        {
          "@id": "caoqorm:components/ActorOptimizeQueryOperationRewriteMove.jsonld#ActorOptimizeQueryOperationRewriteMove_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caoqorm:components/ActorOptimizeQueryOperationRewriteMove.jsonld#ActorOptimizeQueryOperationRewriteMove_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caoqorm:components/ActorOptimizeQueryOperationRewriteMove.jsonld#ActorOptimizeQueryOperationRewriteMove__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caoqorm:components/ActorOptimizeQueryOperationRewriteMove.jsonld#ActorOptimizeQueryOperationRewriteMove__member_test",
          "memberFieldName": "test"
        },
        {
          "@id": "caoqorm:components/ActorOptimizeQueryOperationRewriteMove.jsonld#ActorOptimizeQueryOperationRewriteMove__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caoqorm:components/ActorOptimizeQueryOperationRewriteMove.jsonld#ActorOptimizeQueryOperationRewriteMove_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
