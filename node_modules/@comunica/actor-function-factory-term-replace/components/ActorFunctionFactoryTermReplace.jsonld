{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-replace",
  "components": [
    {
      "@id": "cafftr:components/ActorFunctionFactoryTermReplace.jsonld#ActorFunctionFactoryTermReplace",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermReplace",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionReplace Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermReplace.jsonld#ActorFunctionFactoryTermReplace_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermReplace.jsonld#ActorFunctionFactoryTermReplace_args_bus",
          "range": {
        ...
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermReplace.jsonld#ActorFunctionFactoryTermReplace_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermReplace.jsonld#ActorFunctionFactoryTermReplace_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermReplace.jsonld#ActorFunctionFactoryTermReplace__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermReplace.jsonld#ActorFunctionFactoryTermReplace__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftr:components/ActorFunctionFactoryTermReplace.jsonld#ActorFunctionFactoryTermReplace_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
