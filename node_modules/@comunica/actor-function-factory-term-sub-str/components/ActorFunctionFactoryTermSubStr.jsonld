{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-sub-str",
  "components": [
    {
      "@id": "cafftss:components/ActorFunctionFactoryTermSubStr.jsonld#ActorFunctionFactoryTermSubStr",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermSubStr",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionSubStr Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermSubStr.jsonld#ActorFunctionFactoryTermSubStr_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermSubStr.jsonld#ActorFunctionFactoryTermSubStr_args_bus",
          "range": {
        ...
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermSubStr.jsonld#ActorFunctionFactoryTermSubStr_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermSubStr.jsonld#ActorFunctionFactoryTermSubStr_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermSubStr.jsonld#ActorFunctionFactoryTermSubStr__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermSubStr.jsonld#ActorFunctionFactoryTermSubStr__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftss:components/ActorFunctionFactoryTermSubStr.jsonld#ActorFunctionFactoryTermSubStr_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
