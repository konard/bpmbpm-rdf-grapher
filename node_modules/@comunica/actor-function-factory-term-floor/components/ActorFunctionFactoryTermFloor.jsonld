{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-floor",
  "components": [
    {
      "@id": "cafftf:components/ActorFunctionFactoryTermFloor.jsonld#ActorFunctionFactoryTermFloor",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermFloor",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionFloor Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftf:components/ActorFunctionFactoryTermFloor.jsonld#ActorFunctionFactoryTermFloor_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftf:components/ActorFunctionFactoryTermFloor.jsonld#ActorFunctionFactoryTermFloor_args_bus",
          "range": {
        ...
        {
          "@id": "cafftf:components/ActorFunctionFactoryTermFloor.jsonld#ActorFunctionFactoryTermFloor_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftf:components/ActorFunctionFactoryTermFloor.jsonld#ActorFunctionFactoryTermFloor_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftf:components/ActorFunctionFactoryTermFloor.jsonld#ActorFunctionFactoryTermFloor__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftf:components/ActorFunctionFactoryTermFloor.jsonld#ActorFunctionFactoryTermFloor__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftf:components/ActorFunctionFactoryTermFloor.jsonld#ActorFunctionFactoryTermFloor_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
