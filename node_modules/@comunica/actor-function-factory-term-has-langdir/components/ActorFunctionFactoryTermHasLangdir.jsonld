{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-has-langdir",
  "components": [
    {
      "@id": "caffthl:components/ActorFunctionFactoryTermHasLangdir.jsonld#ActorFunctionFactoryTermHasLangdir",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermHasLangdir",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionIsTriple Function Factory Actor.",
      "parameters": [
        {
          "@id": "caffthl:components/ActorFunctionFactoryTermHasLangdir.jsonld#ActorFunctionFactoryTermHasLangdir_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caffthl:components/ActorFunctionFactoryTermHasLangdir.jsonld#ActorFunctionFactoryTermHasLangdir_args_bus",
          "range": {
        ...
        {
          "@id": "caffthl:components/ActorFunctionFactoryTermHasLangdir.jsonld#ActorFunctionFactoryTermHasLangdir_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caffthl:components/ActorFunctionFactoryTermHasLangdir.jsonld#ActorFunctionFactoryTermHasLangdir_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caffthl:components/ActorFunctionFactoryTermHasLangdir.jsonld#ActorFunctionFactoryTermHasLangdir__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caffthl:components/ActorFunctionFactoryTermHasLangdir.jsonld#ActorFunctionFactoryTermHasLangdir__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caffthl:components/ActorFunctionFactoryTermHasLangdir.jsonld#ActorFunctionFactoryTermHasLangdir_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
