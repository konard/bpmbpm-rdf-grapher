{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-division",
  "components": [
    {
      "@id": "cafftd:components/ActorFunctionFactoryTermDivision.jsonld#ActorFunctionFactoryTermDivision",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermDivision",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionDivision Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDivision.jsonld#ActorFunctionFactoryTermDivision_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDivision.jsonld#ActorFunctionFactoryTermDivision_args_bus",
          "range": {
        ...
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDivision.jsonld#ActorFunctionFactoryTermDivision_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDivision.jsonld#ActorFunctionFactoryTermDivision_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDivision.jsonld#ActorFunctionFactoryTermDivision__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDivision.jsonld#ActorFunctionFactoryTermDivision__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDivision.jsonld#ActorFunctionFactoryTermDivision_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
