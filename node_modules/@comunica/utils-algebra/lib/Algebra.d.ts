...
export type OpenSingle<T> = [T] extends [any[]] ? OpenSingle<T[number]>[] : [
    T
] extends [Algebra.Pattern] ? Algebra.Pattern & withMeta : [
    T
] extends [Algebra.Expression] ? Expression : [
    T
] extends [Algebra.Operation] ? Operation : T;
/**
 * Reverse operation of OpenSingle
 */
export type CloseSingle<T> = T extends any[] ? CloseSingle<T[number]>[] : T extends BoundAggregate ? Algebra.BoundAggregate : T extends Algebra.BaseExpression ? Algebra.Expression : T extends Algebra.BaseOperation ? Algebra.Operation : T;
/**
 ...
 */
export type Opened<T extends object> = {
    [K in keyof T]: OpenSingle<T[K]>;
} & withMeta;
/**
 * Reversed of Opened
 */
export type Closed<T extends object> = {
    [K in keyof T]: CloseSingle<T[K]>;
};
...
export type TypedOperation<T extends Algebra.Types> = Extract<KnownOperation, {
    type: T;
}>;
export type TypedExpression<T extends Algebra.ExpressionTypes> = Extract<KnownOperation, {
    subType: T;
}>;
/**
...
export type Group = Patch<Opened<Algebra.Group>, {
