{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-unary-minus",
  "components": [
    {
      "@id": "cafftum:components/ActorFunctionFactoryTermUnaryMinus.jsonld#ActorFunctionFactoryTermUnaryMinus",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermUnaryMinus",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionUnaryMinus Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftum:components/ActorFunctionFactoryTermUnaryMinus.jsonld#ActorFunctionFactoryTermUnaryMinus_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftum:components/ActorFunctionFactoryTermUnaryMinus.jsonld#ActorFunctionFactoryTermUnaryMinus_args_bus",
          "range": {
        ...
        {
          "@id": "cafftum:components/ActorFunctionFactoryTermUnaryMinus.jsonld#ActorFunctionFactoryTermUnaryMinus_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftum:components/ActorFunctionFactoryTermUnaryMinus.jsonld#ActorFunctionFactoryTermUnaryMinus_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftum:components/ActorFunctionFactoryTermUnaryMinus.jsonld#ActorFunctionFactoryTermUnaryMinus__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftum:components/ActorFunctionFactoryTermUnaryMinus.jsonld#ActorFunctionFactoryTermUnaryMinus__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftum:components/ActorFunctionFactoryTermUnaryMinus.jsonld#ActorFunctionFactoryTermUnaryMinus_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
