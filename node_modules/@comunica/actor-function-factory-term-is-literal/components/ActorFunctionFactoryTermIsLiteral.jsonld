{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-is-literal",
  "components": [
    {
      "@id": "cafftil:components/ActorFunctionFactoryTermIsLiteral.jsonld#ActorFunctionFactoryTermIsLiteral",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermIsLiteral",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionIsLiteral Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftil:components/ActorFunctionFactoryTermIsLiteral.jsonld#ActorFunctionFactoryTermIsLiteral_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftil:components/ActorFunctionFactoryTermIsLiteral.jsonld#ActorFunctionFactoryTermIsLiteral_args_bus",
          "range": {
        ...
        {
          "@id": "cafftil:components/ActorFunctionFactoryTermIsLiteral.jsonld#ActorFunctionFactoryTermIsLiteral_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftil:components/ActorFunctionFactoryTermIsLiteral.jsonld#ActorFunctionFactoryTermIsLiteral_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftil:components/ActorFunctionFactoryTermIsLiteral.jsonld#ActorFunctionFactoryTermIsLiteral__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftil:components/ActorFunctionFactoryTermIsLiteral.jsonld#ActorFunctionFactoryTermIsLiteral__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftil:components/ActorFunctionFactoryTermIsLiteral.jsonld#ActorFunctionFactoryTermIsLiteral_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
