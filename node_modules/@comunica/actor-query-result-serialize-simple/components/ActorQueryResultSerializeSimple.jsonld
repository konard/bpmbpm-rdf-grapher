{
  ...
  "@id": "npmd:@comunica/actor-query-result-serialize-simple",
  "components": [
    {
      "@id": "caqrss:components/ActorQueryResultSerializeSimple.jsonld#ActorQueryResultSerializeSimple",
      "@type": "Class",
      "requireElement": "ActorQueryResultSerializeSimple",
      "extends": [
        "cbqrs:components/ActorQueryResultSerializeFixedMediaTypes.jsonld#ActorQueryResultSerializeFixedMediaTypes"
      ],
      "comment": "A comunica Simple Sparql Serialize Actor.",
      "parameters": [
        {
          "@id": "caqrss:components/ActorQueryResultSerializeSimple.jsonld#ActorQueryResultSerializeSimple_args_mediaTypePriorities",
          "range": "rdf:JSON",
          "default": {
            "@type": "@json",
            "@value": {
        ...
        {
          "@id": "caqrss:components/ActorQueryResultSerializeSimple.jsonld#ActorQueryResultSerializeSimple_args_mediaTypeFormats",
          "range": "rdf:JSON",
          "default": {
            "@type": "@json",
            "@value": {
        ...
        {
          "@id": "caqrss:components/ActorQueryResultSerializeSimple.jsonld#ActorQueryResultSerializeSimple_args_priorityScale",
          "range": {
        ...
        {
          "@id": "caqrss:components/ActorQueryResultSerializeSimple.jsonld#ActorQueryResultSerializeSimple_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
      ...
      "memberFields": [
        {
          "@id": "caqrss:components/ActorQueryResultSerializeSimple.jsonld#ActorQueryResultSerializeSimple__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caqrss:components/ActorQueryResultSerializeSimple.jsonld#ActorQueryResultSerializeSimple__member_testHandleChecked",
          "memberFieldName": "testHandleChecked"
        },
        {
          "@id": "caqrss:components/ActorQueryResultSerializeSimple.jsonld#ActorQueryResultSerializeSimple__member_termToString",
          "memberFieldName": "termToString"
        },
        {
          "@id": "caqrss:components/ActorQueryResultSerializeSimple.jsonld#ActorQueryResultSerializeSimple__member_runHandle",
          "memberFieldName": "runHandle"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caqrss:components/ActorQueryResultSerializeSimple.jsonld#ActorQueryResultSerializeSimple_args__constructorArgument",
          "fields": [
            {
