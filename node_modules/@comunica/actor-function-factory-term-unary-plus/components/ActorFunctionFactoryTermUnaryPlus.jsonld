{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-unary-plus",
  "components": [
    {
      "@id": "cafftup:components/ActorFunctionFactoryTermUnaryPlus.jsonld#ActorFunctionFactoryTermUnaryPlus",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermUnaryPlus",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionUnaryPlus Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftup:components/ActorFunctionFactoryTermUnaryPlus.jsonld#ActorFunctionFactoryTermUnaryPlus_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftup:components/ActorFunctionFactoryTermUnaryPlus.jsonld#ActorFunctionFactoryTermUnaryPlus_args_bus",
          "range": {
        ...
        {
          "@id": "cafftup:components/ActorFunctionFactoryTermUnaryPlus.jsonld#ActorFunctionFactoryTermUnaryPlus_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftup:components/ActorFunctionFactoryTermUnaryPlus.jsonld#ActorFunctionFactoryTermUnaryPlus_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftup:components/ActorFunctionFactoryTermUnaryPlus.jsonld#ActorFunctionFactoryTermUnaryPlus__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftup:components/ActorFunctionFactoryTermUnaryPlus.jsonld#ActorFunctionFactoryTermUnaryPlus__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftup:components/ActorFunctionFactoryTermUnaryPlus.jsonld#ActorFunctionFactoryTermUnaryPlus_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
