{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-addition",
  "components": [
    {
      "@id": "caffta:components/ActorFunctionFactoryTermAddition.jsonld#ActorFunctionFactoryTermAddition",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermAddition",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionAddition Function Factory Actor.",
      "parameters": [
        {
          "@id": "caffta:components/ActorFunctionFactoryTermAddition.jsonld#ActorFunctionFactoryTermAddition_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caffta:components/ActorFunctionFactoryTermAddition.jsonld#ActorFunctionFactoryTermAddition_args_bus",
          "range": {
        ...
        {
          "@id": "caffta:components/ActorFunctionFactoryTermAddition.jsonld#ActorFunctionFactoryTermAddition_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caffta:components/ActorFunctionFactoryTermAddition.jsonld#ActorFunctionFactoryTermAddition_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caffta:components/ActorFunctionFactoryTermAddition.jsonld#ActorFunctionFactoryTermAddition__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caffta:components/ActorFunctionFactoryTermAddition.jsonld#ActorFunctionFactoryTermAddition__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caffta:components/ActorFunctionFactoryTermAddition.jsonld#ActorFunctionFactoryTermAddition_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
