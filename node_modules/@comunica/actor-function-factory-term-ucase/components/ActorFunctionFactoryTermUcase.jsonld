{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-ucase",
  "components": [
    {
      "@id": "cafftu:components/ActorFunctionFactoryTermUcase.jsonld#ActorFunctionFactoryTermUcase",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermUcase",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionUcase Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUcase.jsonld#ActorFunctionFactoryTermUcase_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUcase.jsonld#ActorFunctionFactoryTermUcase_args_bus",
          "range": {
        ...
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUcase.jsonld#ActorFunctionFactoryTermUcase_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUcase.jsonld#ActorFunctionFactoryTermUcase_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUcase.jsonld#ActorFunctionFactoryTermUcase__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUcase.jsonld#ActorFunctionFactoryTermUcase__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUcase.jsonld#ActorFunctionFactoryTermUcase_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
