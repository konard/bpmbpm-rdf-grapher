{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-str-ends",
  "components": [
    {
      "@id": "cafftse:components/ActorFunctionFactoryTermStrEnds.jsonld#ActorFunctionFactoryTermStrEnds",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermStrEnds",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionStrEnds Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftse:components/ActorFunctionFactoryTermStrEnds.jsonld#ActorFunctionFactoryTermStrEnds_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftse:components/ActorFunctionFactoryTermStrEnds.jsonld#ActorFunctionFactoryTermStrEnds_args_bus",
          "range": {
        ...
        {
          "@id": "cafftse:components/ActorFunctionFactoryTermStrEnds.jsonld#ActorFunctionFactoryTermStrEnds_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftse:components/ActorFunctionFactoryTermStrEnds.jsonld#ActorFunctionFactoryTermStrEnds_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftse:components/ActorFunctionFactoryTermStrEnds.jsonld#ActorFunctionFactoryTermStrEnds__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftse:components/ActorFunctionFactoryTermStrEnds.jsonld#ActorFunctionFactoryTermStrEnds__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftse:components/ActorFunctionFactoryTermStrEnds.jsonld#ActorFunctionFactoryTermStrEnds_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
