  ...
  "components": [
    {
      ...
      "@type": "Class",
      "requireElement": "ActorRdfJoinNone",
      "extends": [
        "cbrj:components/ActorRdfJoin.jsonld#ActorRdfJoin"
      ],
      "comment": "A comunica None RDF Join Actor.",
      "parameters": [
        {
          "@id": "carjino:components/ActorRdfJoinNone.jsonld#ActorRdfJoinNone_args_mediatorMergeBindingsContext",
        ...
        {
          "@id": "carjino:components/ActorRdfJoinNone.jsonld#ActorRdfJoinNone_args_busFailMessage",
          "range": {
      ...
      "memberFields": [
        {
          "@id": "carjino:components/ActorRdfJoinNone.jsonld#ActorRdfJoinNone__member_mediatorMergeBindingsContext",
          "memberFieldName": "mediatorMergeBindingsContext",
          "range": "cc:components/Mediator.jsonld#Mediator"
        },
        {
          "@id": "carjino:components/ActorRdfJoinNone.jsonld#ActorRdfJoinNone__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "carjino:components/ActorRdfJoinNone.jsonld#ActorRdfJoinNone__member_test",
          "memberFieldName": "test"
        },
        {
          "@id": "carjino:components/ActorRdfJoinNone.jsonld#ActorRdfJoinNone__member_getOutput",
          "memberFieldName": "getOutput"
        },
        {
          "@id": "carjino:components/ActorRdfJoinNone.jsonld#ActorRdfJoinNone__member_getJoinCoefficients",
          "memberFieldName": "getJoinCoefficients"
        }
      ],
      "constructorArguments": [
        {
          "@id": "carjino:components/ActorRdfJoinNone.jsonld#ActorRdfJoinNone_args__constructorArgument",
          "fields": [
            {
    ...
    {
      "@id": "carjino:components/ActorRdfJoinNone.jsonld#IActorRdfJoinNoneArgs",
      "@type": "AbstractClass",
      "requireElement": "IActorRdfJoinNoneArgs",
      "extends": [
      ...
      "memberFields": [
        {
          "@id": "carjino:components/ActorRdfJoinNone.jsonld#IActorRdfJoinNoneArgs__member_mediatorMergeBindingsContext",
          "memberFieldName": "mediatorMergeBindingsContext"
        }
      ],
      "constructorArguments": []
