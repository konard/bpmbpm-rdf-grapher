{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-uuid",
  "components": [
    {
      "@id": "cafftu:components/ActorFunctionFactoryTermUuid.jsonld#ActorFunctionFactoryTermUuid",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermUuid",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionUuid Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUuid.jsonld#ActorFunctionFactoryTermUuid_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUuid.jsonld#ActorFunctionFactoryTermUuid_args_bus",
          "range": {
        ...
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUuid.jsonld#ActorFunctionFactoryTermUuid_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUuid.jsonld#ActorFunctionFactoryTermUuid_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUuid.jsonld#ActorFunctionFactoryTermUuid__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUuid.jsonld#ActorFunctionFactoryTermUuid__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftu:components/ActorFunctionFactoryTermUuid.jsonld#ActorFunctionFactoryTermUuid_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
