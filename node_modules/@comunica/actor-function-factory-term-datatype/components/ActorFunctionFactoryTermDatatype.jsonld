{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-datatype",
  "components": [
    {
      "@id": "cafftd:components/ActorFunctionFactoryTermDatatype.jsonld#ActorFunctionFactoryTermDatatype",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermDatatype",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionDatatype Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDatatype.jsonld#ActorFunctionFactoryTermDatatype_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDatatype.jsonld#ActorFunctionFactoryTermDatatype_args_bus",
          "range": {
        ...
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDatatype.jsonld#ActorFunctionFactoryTermDatatype_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDatatype.jsonld#ActorFunctionFactoryTermDatatype_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDatatype.jsonld#ActorFunctionFactoryTermDatatype__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDatatype.jsonld#ActorFunctionFactoryTermDatatype__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftd:components/ActorFunctionFactoryTermDatatype.jsonld#ActorFunctionFactoryTermDatatype_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
