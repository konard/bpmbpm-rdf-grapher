{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-langmatches",
  "components": [
    {
      "@id": "cafftl:components/ActorFunctionFactoryTermLangmatches.jsonld#ActorFunctionFactoryTermLangmatches",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermLangmatches",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionLangmatches Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftl:components/ActorFunctionFactoryTermLangmatches.jsonld#ActorFunctionFactoryTermLangmatches_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftl:components/ActorFunctionFactoryTermLangmatches.jsonld#ActorFunctionFactoryTermLangmatches_args_bus",
          "range": {
        ...
        {
          "@id": "cafftl:components/ActorFunctionFactoryTermLangmatches.jsonld#ActorFunctionFactoryTermLangmatches_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftl:components/ActorFunctionFactoryTermLangmatches.jsonld#ActorFunctionFactoryTermLangmatches_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftl:components/ActorFunctionFactoryTermLangmatches.jsonld#ActorFunctionFactoryTermLangmatches__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftl:components/ActorFunctionFactoryTermLangmatches.jsonld#ActorFunctionFactoryTermLangmatches__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftl:components/ActorFunctionFactoryTermLangmatches.jsonld#ActorFunctionFactoryTermLangmatches_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
