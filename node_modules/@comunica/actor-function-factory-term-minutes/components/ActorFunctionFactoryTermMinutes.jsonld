{
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-minutes",
  "components": [
    {
      "@id": "cafftm:components/ActorFunctionFactoryTermMinutes.jsonld#ActorFunctionFactoryTermMinutes",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermMinutes",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionMinutes Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMinutes.jsonld#ActorFunctionFactoryTermMinutes_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMinutes.jsonld#ActorFunctionFactoryTermMinutes_args_bus",
          "range": {
        ...
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMinutes.jsonld#ActorFunctionFactoryTermMinutes_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMinutes.jsonld#ActorFunctionFactoryTermMinutes_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMinutes.jsonld#ActorFunctionFactoryTermMinutes__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMinutes.jsonld#ActorFunctionFactoryTermMinutes__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMinutes.jsonld#ActorFunctionFactoryTermMinutes_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
