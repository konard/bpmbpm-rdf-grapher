{
  "@context": [
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-function-factory-term-md5/^5.0.0/components/context.jsonld",
  ...
  "@id": "npmd:@comunica/actor-function-factory-term-md5",
  "components": [
    {
      "@id": "cafftm:components/ActorFunctionFactoryTermMd5.jsonld#ActorFunctionFactoryTermMd5",
      "@type": "Class",
      "requireElement": "ActorFunctionFactoryTermMd5",
      "extends": [
        "cbff:components/ActorFunctionFactoryDedicated.jsonld#ActorFunctionFactoryDedicated"
      ],
      "comment": "A comunica TermFunctionMd5 Function Factory Actor.",
      "parameters": [
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMd5.jsonld#ActorFunctionFactoryTermMd5_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMd5.jsonld#ActorFunctionFactoryTermMd5_args_bus",
          "range": {
        ...
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMd5.jsonld#ActorFunctionFactoryTermMd5_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMd5.jsonld#ActorFunctionFactoryTermMd5_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMd5.jsonld#ActorFunctionFactoryTermMd5__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMd5.jsonld#ActorFunctionFactoryTermMd5__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "cafftm:components/ActorFunctionFactoryTermMd5.jsonld#ActorFunctionFactoryTermMd5_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
