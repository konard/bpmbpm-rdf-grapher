{
  ...
  "@id": "npmd:@comunica/actor-optimize-query-operation-rewrite-copy",
  "components": [
    {
      "@id": "caoqorc:components/ActorOptimizeQueryOperationRewriteCopy.jsonld#ActorOptimizeQueryOperationRewriteCopy",
      "@type": "Class",
      "requireElement": "ActorOptimizeQueryOperationRewriteCopy",
      "extends": [
        "cboqo:components/ActorOptimizeQueryOperation.jsonld#ActorOptimizeQueryOperation"
      ],
      "comment": "A comunica Rewrite Copy Optimize Query Operation Actor.",
      "parameters": [
        {
          "@id": "caoqorc:components/ActorOptimizeQueryOperationRewriteCopy.jsonld#ActorOptimizeQueryOperationRewriteCopy_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caoqorc:components/ActorOptimizeQueryOperationRewriteCopy.jsonld#ActorOptimizeQueryOperationRewriteCopy_args_bus",
          "range": {
        ...
        {
          "@id": "caoqorc:components/ActorOptimizeQueryOperationRewriteCopy.jsonld#ActorOptimizeQueryOperationRewriteCopy_args_busFailMessage",
          "range": {
        ...
        {
          "@id": "caoqorc:components/ActorOptimizeQueryOperationRewriteCopy.jsonld#ActorOptimizeQueryOperationRewriteCopy_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "caoqorc:components/ActorOptimizeQueryOperationRewriteCopy.jsonld#ActorOptimizeQueryOperationRewriteCopy__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caoqorc:components/ActorOptimizeQueryOperationRewriteCopy.jsonld#ActorOptimizeQueryOperationRewriteCopy__member_test",
          "memberFieldName": "test"
        },
        {
          "@id": "caoqorc:components/ActorOptimizeQueryOperationRewriteCopy.jsonld#ActorOptimizeQueryOperationRewriteCopy__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caoqorc:components/ActorOptimizeQueryOperationRewriteCopy.jsonld#ActorOptimizeQueryOperationRewriteCopy_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
