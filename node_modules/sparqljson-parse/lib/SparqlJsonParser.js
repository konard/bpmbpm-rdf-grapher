...
class SparqlJsonParser {
     ...
     */
    parseJsonResults(sparqlResponse, version) {
     ...
     */
    parseJsonResultsStream(sparqlResponseStream, version) {
     ...
     * @return {IBindings[]} An array of bindings.
     */
    parseJsonBoolean(sparqlResponse, version) {
        if (version && !this.isValidVersion(version)) {
            throw new Error(`Detected unsupported version as media type parameter: ${version}`);
        }
     ...
     */
    parseJsonBooleanStream(sparqlResponseStream, version) {
        if (version && !this.isValidVersion(version)) {
...
SparqlJsonParser.SUPPORTED_VERSIONS = [
    '1.2',
    '1.2-basic',
    '1.1',
];
