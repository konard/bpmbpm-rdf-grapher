...
export default class SHACLCWriter {
    ...
    private readonly requireBase;
    private prefixes;
    private prefixRev;
    private writer;
    constructor(store: Store, writer: Writer, prefixes?: {
        [prefix: string]: string | RDF.NamedNode;
    }, base?: NamedNode | undefined, errorOnExtraQuads?: boolean, mintUnspecifiedPrefixes?: boolean, fetch?: typeof globalThis.fetch | undefined, extendedSyntax?: boolean, requireBase?: boolean);
    /**
