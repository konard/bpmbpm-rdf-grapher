...
class SHACLCWriter {
    ...
    writer, prefixes = {}, 
    // eslint-disable-next-line no-unused-vars
    base = undefined, errorOnExtraQuads = true, mintUnspecifiedPrefixes = false, fetch, extendedSyntax = false, requireBase = true) {
        this.store = store;
        this.base = base;
    ...
    write() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (onotology.length === 1 && onotology[0].subject.termType === 'NamedNode') {
                ...
                // Don't write default
                if (!base.equals(n3_1.DataFactory.namedNode('urn:x-base:default')))
    ...
    writeImports(base) {
        return __awaiter(this, void 0, void 0, function* () {
            const imports = this.store.getObjectsOnce(base, n3_1.DataFactory.namedNode("http://www.w3.org/2002/07/owl#imports" /* owl.imports */), null);
            if (imports.length > 0) {
    ...
    termToString(term_1) {
        return __awaiter(this, arguments, void 0, function* (term, disableShaclName = false, allowBlankNodes = false) {
    ...
    writeShapes() {
        return __awaiter(this, void 0, void 0, function* () {
             ...
             */
            for (const subject of this.store.getSubjectsOnce(n3_1.DataFactory.namedNode("http://www.w3.org/1999/02/22-rdf-syntax-ns#type" /* rdf.type */), n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#NodeShape" /* sh.NodeShape */), null)) {
                if (this.store.getQuadsOnce(subject, n3_1.DataFactory.namedNode("http://www.w3.org/1999/02/22-rdf-syntax-ns#type" /* rdf.type */), n3_1.DataFactory.namedNode("http://www.w3.org/2000/01/rdf-schema#Class" /* rdfs.Class */), null).length > 0) {
                ...
                this.writer.add(' ');
                const targetClasses = this.store.getObjectsOnce(subject, n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#targetClass" /* sh.targetClass */), null);
                if (targetClasses.length > 0) {
                    ...
                    for (const targetClass of targetClasses) {
                        if (targetClass.termType === 'NamedNode') {
                            ...
                            this.writer.add('!');
                            this.writer.add(yield this.termToString(this.singleObject(targetClass, n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#not" /* sh.not */), true)));
                        }
                        this.writer.add(' ');
                    }
                }
                const unusedPredicates = this.store.getPredicates(subject, null, null)
                    .filter((property) => [
                    n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#targetClass" /* sh.targetClass */),
                    n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#property" /* sh.property */),
                    // TODO: See if "and" should be here as well
                    n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#or" /* sh.or */),
                    ...Object.keys(node_param_1.default).map((key) => n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#" /* sh._ */ + key)),
    ...
    getList(term) {
        ...
        while (!termTemp.equals(n3_1.DataFactory.namedNode("http://www.w3.org/1999/02/22-rdf-syntax-ns#nil" /* rdf.nil */))) {
            list.push(this.singleObject(termTemp, n3_1.DataFactory.namedNode("http://www.w3.org/1999/02/22-rdf-syntax-ns#first" /* rdf.first */), true));
            termTemp = this.singleObject(termTemp, n3_1.DataFactory.namedNode("http://www.w3.org/1999/02/22-rdf-syntax-ns#rest" /* rdf.rest */), true);
        }
        return list;
    }
    ...
    writeAssigment(_a) {
        return __awaiter(this, arguments, void 0, function* ({ name, type, object }) {
            if (type === 'not') {
                this.writer.add('!');
    ...
    writeAssigments(assignments_1) {
        return __awaiter(this, arguments, void 0, function* (assignments, divider = ' ', first = true, shortcuts) {
    ...
    writeParams(term_1) {
        return __awaiter(this, arguments, void 0, function* (term, first = true, allowedParam, shortcuts = false, surroundings = false) {
    ...
    writeShapeBody(term_1) {
        return __awaiter(this, arguments, void 0, function* (term, nested = true) {
            this.writer.add('{').indent();
            const properties = this.store.getObjectsOnce(term, n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#property" /* sh.property */), null);
    ...
    writeProperty(property) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.writePath(this.singleObject(property, n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#path" /* sh.path */), true));
            const min = this.singleObject(property, n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#minCount" /* sh.minCount */));
            const max = this.singleObject(property, n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#maxCount" /* sh.maxCount */));
            const nodeKind = this.singleObject(property, n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#nodeKind" /* sh.nodeKind */));
            // eslint-disable-next-line no-underscore-dangle
            const propertyClass = this.singleObject(property, n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#class" /* sh._class */));
            const datatype = this.singleObject(property, n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#datatype" /* sh.datatype */));
            const nodeShapes = this.store.getObjectsOnce(property, n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#node" /* sh.node */), null);
            if (nodeKind) {
                this.writer.add(' ');
            ...
            if (min !== undefined || max !== undefined) {
                ...
                if (max) {
                    ...
                    this.store.removeMatches(property, n3_1.DataFactory.namedNode("http://www.w3.org/ns/shacl#maxCount" /* sh.maxCount */), undefined, undefined);
    ...
    writePath(term_1) {
        return __awaiter(this, arguments, void 0, function* (term, braces = false) {
            if (term.termType === 'NamedNode') {
                this.writer.add(yield this.termToString(term));
            }
