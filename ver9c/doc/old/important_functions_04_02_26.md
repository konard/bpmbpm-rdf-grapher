...
# Наиболее важные функции RDF Grapher ver9c
...
Чтение и запись осуществляются через SPARQL-запросы (`funSPARQLvalues` для SELECT, `applyTripleToRdfInput` для INSERT/DELETE).
