...
Данный документ определяет концептуальные правила для реализации **Идеального Quadstore** в проекте RDF Grapher ver9c. Эти правила направлены на создание чистой архитектуры Linked Data без дублирующих объектов хранения.
