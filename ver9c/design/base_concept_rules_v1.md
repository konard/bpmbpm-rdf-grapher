...
Данный документ определяет концептуальные правила для реализации **Идеального Quadstore** в проекте RDF Grapher ver9c. Версия 1 расширяет базовые правила поддержкой **полной семантизации** через comunica-feature-reasoning и интеграцию с базовой онтологией VAD.
...
- [issue #359: ver9c_5rea1](https://github.com/bpmbpm/rdf-grapher/issues/359)
