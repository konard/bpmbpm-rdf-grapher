...
2. [Примеры миграции из кода ver9c](#2-примеры-миграции-из-кода-ver9c)
...
4. [Реальные примеры из ver9c](#4-реальные-примеры-из-ver9c)
...
Данный документ дополняет [sparql-driven-programming_min1.md](sparql-driven-programming_min1.md) и содержит **практические примеры** из кодовой базы ver9c, демонстрирующие применение концепции SPARQL-driven programming.
...
## 2. Примеры миграции из кода ver9c
