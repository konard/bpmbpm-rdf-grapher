...
4. Минимизация зависимостей: каждый модуль должен зависеть только от `9_vadlib_` (vadlib_logic.js и vadlib_sparql.js и других) и, при необходимости, от данных в глобальных переменных
5. **SPARQL-driven Programming:** все SPARQL запросы размещайте в `_sparql.js` файлах, а не inline в коде логики
6. **Типовые SPARQL запросы:** запросы, используемые несколькими модулями, выносите в `vadlib_sparql.js`
7. **Документация:** соблюдай [auto documentation requirements](https://github.com/bpmbpm/rdf-grapher/blob/main/ver9c/doc/autodoc.md)
